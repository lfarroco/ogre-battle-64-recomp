...
| `OGRE_CONVERT_TRACE=1` | `[convert]` the YUV→RGB matrix the game programs with `G_SETCONVERT` (`k0..k5`). The YUV16 decode uses it; the game sets `k0=175 k1=469 k2=423 k3=222` |
