...
Rows written before session 97 name build files at the repository root
(`config.toml`, `config-bank<U>.{yaml,toml}`, `rsp-*.toml`, `symbol_addrs*.txt`,
`reloc_addrs.txt`, `*.patch`). Session 97 moved them under `config/`,
`config/banks/`, `config/symbols/` and `patches/`; the session-97 row records the
mapping.

| date (session)      | decision                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|---------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2026-09-25 (106)    | **SOUNDS and VOLUME are the SETTINGS tab's two audio rows, and the gain is applied in the audio callback, where a mute queues silence rather than nothing.** Developer request: a sound control under SETTINGS in the `ESC` overlay, `sounds [x] on [ ] off` and a `volume` slider over `0..100%` whose handle moves along the bar (`\|----------` at 0, `-----|-----` at 50, `----------\|` at 100). Landed: `settings.{hpp,cpp}` gained `SoundMode{On,Off}` (enumerators in row order, so `On` is option 0 and the default), `sound_mode_label`/`sound_mode_text`, a 0..100 volume with `kVolumeStepPercent = 5`, `kVolumeCells = 11` and `kVolumeDefaultPercent = 100`, `volume_handle_cell` (`round(percent * 10 / 100)`), `volume_percent_for_cell` (`cell * 100 / 10`), `volume_text` (the 11-char bar with `\|` on the handle cell plus ` <n>%`), and the keys `sounds = off\|on` and `volume = <0..100>` at `<config>/settings.cfg`; a file with neither key (written before the rows existed) loads as `On` / `100`, a typo in `sounds` is read as `On` rather than starting muted, and `volume` is clamped. `OGRE_SOUNDS` / `OGRE_VOLUME` override the file for one run without writing it, the `OGRE_SPEED` rule. `ui.{hpp,cpp}` gained `RowKind::Sound` and `RowKind::Volume` (the SETTINGS tab shows an `AUDIO` section, then `SOUNDS` and `VOLUME`), a `SliderLayout`/`layout_volume` helper beside the radio rows' `RadioLayout` so measure and draw cannot drift, the left/right text, the activate/choose_option arms (SOUNDS wraps like the other radio groups; VOLUME steps 5% and clamps, and a click on one of the 11 cells sets that cell's 10%), and a draw arm that renders the bar as one text run and pushes one click rect per cell; `launcher.cpp` and `overlay.cpp` added the two kinds to their `LEFT`/`RIGHT` row lists. `SoundMode`'s ordering is the row's display order so the row reads `[x] ON [ ] OFF`, as the request wrote it. **The mute is a gain of 0, not a skipped queue:** `ultramodern::audio_dma_busy()` paces the game's audio generation from `get_frames_remaining` (`audio.cpp:108`), so a mute that queued nothing would report the AI idle and make the game overproduce; `queue_audio_samples` (`app/src/sdl_platform.cpp`) therefore queues the game's buffer unchanged at 100, a scaled copy from a scratch buffer (never in place: `samples` points into RDRAM and the next AI buffer may be live there) below 100, and a zeroed copy at 0, with the same frame count at every gain. **Verified** on `build-app/ogrebattle64`: both SETTINGS screens draw `SOUNDS  [x] ON [ ] OFF` and `VOLUME  ----------\| 100%` (`docs/proofs/native-overlay-settings.png` and `-launcher-settings.png` refreshed; both proofs were stale and still showed the retired three-option widescreen row); `OGRE_OVERLAY_KEYS="Down,Down,Down,Left x7"` writes `volume = 65`, and the row reads `-------\|--- 65%` (handle cell 7, the rounding the 11 cells imply); `Down,Down,Space` writes `sounds = off`; `sounds = off` / `volume = 40` loads as `sounds off, volume 40%`, `volume = 250` as `100%`, `sounds = maybe` as `on`, and a file with neither key as `on` / `100`; `OGRE_SOUNDS` / `OGRE_VOLUME` win over the file and leave it unwritten. A temporary `probe106` in `queue_audio_samples` (reverted; `grep -rl probe106` is empty) measured the arithmetic: gain 50 gives `peak_out = peak_in/2` (20097→10048, 16245→8122, 3335→1667) and gain 0 gives `peak_out = 0` with `samples = 1104` and `queued = 7842` int16 still on the device on every buffer, which is the pacing claim. **Not verified:** a mouse click on a slider cell (no synthetic-mouse hook exists; the cell rects come from the same fixed-cell geometry as the drawn bar), and the browser build, which reads no `settings.cfg` and has no settings UI, so `app/src/web_platform.cpp` still plays at full volume. | `app/src/settings.{hpp,cpp}`, `app/src/ui.{hpp,cpp}`, `app/src/launcher.cpp`, `app/src/overlay.cpp`, `app/src/sdl_platform.cpp`, `docs/guides/app-build.md` (the SETTINGS section and the `OGRE_SOUNDS` / `OGRE_VOLUME` knob rows), `docs/proofs/native-overlay-settings.png`, `docs/proofs/native-launcher-settings.png`, `PLAN.md`, `docs/STATUS-LOG.md`, `docs/HANDOFF-2026-09-25-session106.md` |
| 2026-09-25 (105)    | **WIDESCREEN is a toggle (`off` / `on`), and the three-option `off` / `missions` / `always` row is retired.** Developer report: the two widescreen options make no visible difference, because both open the same 16:9 window for the whole run and leave black side bars on the non-mission scenes; the split was a leftover from the first implementation, which resized the window at every scene change. `settings.{hpp,cpp}` now defines `WidescreenMode{Off,On}` with `kWidescreenModeCount = 2`, `widescreen_mode_label` returns `OFF` / `ON`, and the file writes `widescreen = off\|on`; `parse_widescreen` still reads the retired `missions`, `always`, `1`, `2` and `true` spellings as `on`, and `off` / `0` as `off`, in both `settings.cfg` and `OGRE_WIDESCREEN`, so a saved file keeps its behaviour. `widescreen.cpp`'s `wants_expand()` is `widescreen_mode() != Off && active_scene_id() == 0x03`, which is the old `missions` rule: Expand during the mission only, so the old `always` (which stretched the boot's full-screen 2D stills) is gone and the 2D screens keep their 4:3 authoring. The window rule is unchanged: `off` opens 4:3 and `on` opens 16:9, and only a toggle change re-fits it. `ui.cpp`, `launcher.cpp` and `overlay.cpp` needed no change, because the radio group iterates `kWidescreenModeCount` and the row-kind checks already include `RowKind::Widescreen`. **Verified (macOS, `build-dist/ogrebattle64`):** the SETTINGS tab draws `WIDESCREEN   [ ] OFF [x] ON`; `Down,Right` writes `widescreen = on` and the next boot logs `game speed x1, widescreen on`; `OGRE_WIDESCREEN` with `missions`, `always`, `on`, `1` or `2` logs `widescreen on` and with `off` or `0` logs `widescreen off`; a 40 s suspend-save run logs `aspect ratio expand (scene 0x0003, mode ON)` on each of two mission visits and `original` on the intervening scene `0x0002`; an overlay run draws the same row and writes `widescreen = on` while re-fitting the window once (`960x720 -> 1280x720`). | `app/src/settings.{hpp,cpp}`, `app/src/widescreen.{hpp,cpp}`, `app/src/main.cpp` (comment), `docs/guides/app-build.md`, `docs/proofs/native-widescreen-launcher.png` (refreshed), `docs/proofs/native-widescreen-overlay.png` (new), `PLAN.md`, `docs/STATUS-LOG.md`, `docs/README.md`, `docs/HANDOFF-2026-09-25-session105.md` |
| 2026-09-25 (104)    | **The ROM tab is gone and the shared panel's position is fixed: `PanelMetrics::layout_height` is the taller of the active tab and `kLayoutReferenceTab` (CONTROLS), and both screens centre the block, place the footer and fill the background with it.** Developer request, twice: the ROM tab is redundant because an unloaded start screen can offer the picker on the START GAME tab, and the UI moved depending on how tall the active tab's content is. Landed: `ui::Tab::Rom` removed; `Panel::build_rows(Tab)` (new; `rebuild_rows` was refactored into it) puts `RowKind::Rom` on START GAME after `RowKind::Start`, and the existing `select_first()`/`selectable()` pair already lands the selection on the ROM row while `rom_` is empty, so `SPACE` and a click open the picker with no new flow; the row's left text is `[x] ROM loaded`; the launcher's error hint is `PRESS SPACE ON THE ROM ROW TO TRY AGAIN` and `OGRE_LAUNCHER_TAB=rom` is dropped. For the position: the panel's height is `tab bar + rows + hint` and `rows` depends on the tab, so centring with it moved the header on every tab change. `measure_panel` now measures the active tab and the reference tab with one shared helper (`layout_rows`, which takes the row list and a `keep_lines` flag: only the drawn tab needs its wrapped right-column lines) and reports `layout_height = max(height, reference height)`; `Panel::layout_rows_` holds the reference rows, built by the same `build_rows(kLayoutReferenceTab)` call, so the two lists cannot be built two different ways. `launcher.cpp` and `overlay.cpp` use it for `block_height` and for the footer's `cursor_y`, and `draw_panel` sizes the panel background with it, so the frame is the same on every tab. CONTROLS is the reference because it is the tallest (a wrapped binding row makes it 1028 px at `ui_scale` 2); a tab taller than it (a long mod list) still grows the block, because the value is a `max` and not a constant. The launcher's error block still adds to `block_height`, so a rejected ROM re-centres as before — that is a separate screen state, not a tab. **Verified** on `build-dist/ogrebattle64`: five launcher PPMs at 2560x1440 (start/mods/controls/settings/debug) put the title at rows 48..117, the rule at 202..205, the panel background's top at 302 and the footer at 1382..1417 on every tab, and differ first at row 332 (the active tab label's colour); the pre-change build, captured for the A/B by stashing the four source files, put the title at row 446 on START GAME (one panel row), row 423 on SETTINGS and row 48 on CONTROLS, so the header moved by up to 398 px between tabs. The no-ROM capture (empty cwd, fresh pref dir, `OGRE_LAUNCHER=1`) shows `[ ] Start Game` dimmed and `[ ] No ROM` selected; the overlay captures for CONTROLS and SETTINGS share their header and tab-bar y (all content in rows 66..1365, first difference at 242); `OGRE_LAUNCHER_KEYS=space` still logs `[launcher] accepted` and boots; `OGRE_OVERLAY_KEYS=tab,tab,up,down` navigates without error; `build-null` compiles warning-free. **The first verification round was invalid**: it ran `build-app/ogrebattle64`, which `make app` does not write (`DIST_STATIC_SDL ?= 1` sends it to `build-dist/`), and measured a binary from before the change; the same trap sessions 99 and 102 record. **Not verified:** no human saw the frame on a real window, and no installed mod has enough config rows to exercise `layout_height`'s `max` arm. | `app/src/ui.{hpp,cpp}`, `app/src/launcher.cpp`, `app/src/overlay.cpp`, `docs/guides/app-build.md`; captures `/tmp/ogre-ui-shots/{start,mods,controls,settings,debug,norom}.ppm`; proofs `docs/proofs/native-launcher-{start,controls,mods,settings}.png` (refreshed) and the deleted `native-launcher-rom.png`; `docs/HANDOFF-2026-09-25-session104.md` |
| 2026-09-25 (103)    | **The EXP Overflow mod carries a level-up's leftover EXP over, and it does so from a base-section frame hook because neither the result loop nor the level-up routine can be hooked.** Ogre Battle 64 levels a character at 100 EXP. The battle-result loop `func_ovlJ_801D61C0` (state 4 at 0x801D634C: `lbu v0,50(s0)` / `sltiu v0,v0,100` / `sb zero,50(s0)` in the delay slot of `jal func_ovlJ_801D8E90` / `jal func_8016EBC4`) lives in **streamed bank unit J** (record 10's arena), and the port's mod system resolves a hook through `get_vrom_to_section_map()`, which is built from the base ELF's sections, so a bank hook cannot load (`docs/guides/app-build.md` → "What a hook can reach"). `func_8016EBC4` (the level-up routine) *is* in `.streamedB` but is unhookable: entry and return hooks both load and then fault during boot (`Failed to find function at 0x46220003`, SIGSEGV in `func_80071EB0`'s loop), while its neighbours `func_8016E1FC` (0x54) and `func_8016DE3C` (0x54) and the example mod's `func_80177DCC` (0x3C) hook cleanly, so the target is the problem, not the section. Landed as `mods/exp-overflow/`: a `RECOMP_HOOK("func_80072944")` tick (measured 3072 entries over a 3203-frame run; `func_80075BC0` is the one-shot scene-table setup and `func_80089BC0`/`func_80072900`/`func_800728BC` are boot-only, `func_80072398` faults with SIGBUS) scans the result state at `*(0x801CE8DC)` and, for every participant with working EXP ≥ 100, remembers `exp-100` and the participant level against the roster index (`participant+0xF6`); once the record shows `level+1` it writes the remainder into `record+0x35` **and** into the live `participant+0x32`, and holds both for 120 frames. The participant write is load-bearing: a record-only write is undone by the next participant → record sync (observed: the record read 20 for one snapshot, then 0). Addresses: record `n` at `0x80193BE0 + n*0x38`, level `+0x13`, EXP `+0x35`; result state `*(0x801CE8DC)`, state word `+0x6048`, participant `n` at `+n*248+452` (live when `+n*248+524` is nonzero), level `+0x31`, EXP `+0x32`, roster index `+0xF6`. **Verified** against the developer's attached suspend save (`scene_4_suspend.bin`): four front-row soldiers of Dio's unit at 89 EXP crossed 100, reached level +1 and ended at **20 EXP**, and 20 survived the following battle; a debug counter read out of a scratch word recorded 4 record writes and 4 participant writes with remainder 20; the same fight without the mod ends at 0. Instrumentation removed and rebuilt clean. | `mods/exp-overflow/{mod.toml,mod.ld,include/modding.h,src/exp_overflow.c,README.md}`; `mods/skip-boot-logos/` as the reference; snapshots `/tmp/ov3-68/72/73.bin` and `/tmp/ov3-exit.bin`; `docs/HANDOFF-2026-09-25-session103.md` |
| 2026-09-25 (102)    | **WIDESCREEN is a mode (`off` / `missions` / `always`), not an aspect ratio, and `app/src/widescreen.cpp` is the only writer of RT64's `ar_option`.** The developer asked for widescreen during missions, because the game's 2D screens are authored for 4:3. RT64 already implements the widening: `rt64_workload_queue.cpp:134-211` derives an `aspectRatioScale` from the window and `ProjectionProcessor::processScene` (`rt64_projection_processor.cpp:101`) counter-scales the projection matrices by `1/scale` for projections that cover the screen and are wider than tall, so the 3D field is hor+ rather than stretched; the port already forwarded `config.ar_option` (`renderer.cpp:123`) and handled a runtime change (`update_config`, `:917`). Landed: `settings.{hpp,cpp}` gained `WidescreenMode{Off,Missions,Always}`, a `widescreen = off\|missions\|always` key in `<config>/settings.cfg` (the loader now matches keys rather than taking the first integer in the file, which a second key made ambiguous), the accessors the panel reads, and `OGRE_WIDESCREEN` as the one-run debug override under the `OGRE_SPEED` rule (it wins over the file and is not written back); `widescreen.{hpp,cpp}` computes the wanted `ar_option` from the mode and the dispatcher's active scene (`D_800E810E`; scene `0x03` is the mission) and writes `ultramodern::renderer::set_graphics_config` only when the live value differs, so the renderer sees one `update_config` per transition; `main.cpp`'s `update_gfx` calls it beside `poll_scene()` because the scene can change on any frame; `ui.{hpp,cpp}` gained `RowKind::Widescreen` and the GAME SPEED radio layout was generalised (`layout_radio`, `RadioToken`/`RadioLayout`) so both rows share measure/draw/click geometry; `launcher.cpp` and `overlay.cpp` step the new row with `LEFT`/`RIGHT`. Not a mod: the mod API hooks recompiled guest functions, and this is app plus renderer configuration. **Verified (macOS, `build-dist/ogrebattle64`, the target of `make app` here because `DIST_STATIC_SDL ?= 1`):** the launcher SETTINGS tab draws `WIDESCREEN [x] OFF [ ] MISSIONS [ ] ALWAYS` (`docs/proofs/native-widescreen-launcher.png`); `Down,Right` writes `widescreen = missions` and the next boot logs `widescreen missions`; the in-game overlay steps the same row; with `OGRE_SAVE=assets/escort_suspend.bin` + `OGRE_TAP_SCENE_BUTTON="title:start:6,0x12:a:4,0x03:a:6"` a `missions` run logs `aspect ratio expand (scene 0x0003)` on every `0x03` visit and `original` on each `0x02`/`0x0D` between them (three visits, run exit 0), while an `off` run logs no transition at all; `always` at the title logs `expand` at frame 1; and no `[widescreen] window` line follows a scene change in any mode. **The window's shape follows the mode, not the scene (developer correction).** The first version sized the window from the effective aspect at every transition: in `missions` mode the window grew when a mission started and shrank when a story scene did. The developer rejected that (*"the window changes its size while the game is running"*) and the requested rule is the shipped one: `off` opens a 4:3 window and never changes, `missions`/`always` open a 16:9 window and never change, and the 4:3 scenes of a widescreen run are pillarboxed inside it. `create_window` asks `widescreen_initial_window_size`, then `widescreen_fit_window` re-derives the width from the height the window actually got (the window manager returns 715 for a requested 720, which left a few pixels of bar at the old fixed width); `widescreen_update` returns whether the *mode* changed and only that re-fits the window, so changing the mode from the launcher or the overlay resizes once and a scene transition never does. A manual resize or a double-click to fill the screen is left alone. **Visual:** with `off` the window opens 953x715 and the 4:3 picture reaches both edges (`native-widescreen-43-window.png`; this was the developer's first report about the old fixed 1280x720 window); with `missions` the window opens 1271x715 and the identical Load Game screen has black side bars (`native-widescreen-pillarbox.png`), while a battle in the mission fills the width (`native-widescreen-mission-expand.png`, and `-mission-43.png` for the same battle in `off`; not the same battle frame, but the same area and camera). The mission's projected 2D HUD keeps its proportions, and the `MISSION` banner row clips at both edges in 4:3 too (it is the game's own scrolling marquee, not an Expand artifact). `always` stretches the full-screen 2D blits (the publisher stills), which is the documented reason it is not the default. Not tested: audio with widescreen; the Windows/Linux builds; the tutorial's practice stage (scene `0x17`, deliberately left 4:3). | `app/src/widescreen.{hpp,cpp}` (new), `app/src/settings.{hpp,cpp}`, `app/src/ui.{hpp,cpp}`, `app/src/launcher.cpp`, `app/src/overlay.cpp`, `app/src/main.cpp`, `app/CMakeLists.txt`, `docs/guides/app-build.md`; proofs `docs/proofs/native-widescreen-{launcher,mission-expand,mission-43}.png`; logs `/tmp/ws-launcher2.log`, `/tmp/ws5-missions.log`, `/tmp/ws6-off.log` |
| 2026-09-25 (101)    | **The Organize Screen's DEF/MDEF "extra digit" was RT64's "Fix LR with Scissor" enhancement rewriting the digit's rectangle, and it is off by default now.** The developer's retail cutout of the same panel has no extra pixels, so the port was wrong. The screen is scene `0x06` (one F3DEX2 display list at `0x80257E50`); each digit is a 6x7-px `G_TEXRECT` at `dsdx` = 1 texel per pixel (`28` = `(288,66)-(294,73)` s=48 plus `(281,66)-(287,73)` s=12), and the font sheet (`0x801FFCF8`, 64x64 CI4) has the digits in 6-texel cells, so the dark column at `x=294` is cell 9's column 0 after `8` (and cell 2's column 0 after `1`). The panel scissor is `(100,84)-(1180,612)`. `RDP::drawRect` (`tools/RT64/src/hle/rt64_rdp.cpp`) does `if ((abs(scissorRect.lrx - lrx) <= 4) && (ulx < scissorRect.lrx)) lrx = scissorRect.lrx;` under `enhancementConfig.rect.fixRectLR` (RT64's "Fix LR with Scissor", default true, for games that under-draw a full-screen background): `abs(1180 - 1176) == 4`, so the 6-px glyph rectangle became 7 px and its last pixel sampled texel 54 — the next font cell. A temporary `probe101` trace in `rt64_framebuffer_renderer.cpp` printed the draw call as `raw 1152,264..1180,292 ... cycle=0 dsdx=1024` where the display list word in the same dump is `lrx=1176`, which ruled out the copy-mode adjustment (`lrx |= 3` would show `dsdx=256`) and any tile-window limit (`t.lrs=252` = 63 texels). The reference emulator is clean because parallel-rdp has no such enhancement: `CommandBuilder::tex_rect` stores `lrx = x + width - 4` in 1/4-px units and `span_setup.comp` snaps each edge with `(x >> 12) | sticky`, so it covers the six pixels the display list asks for. **Fix:** `app/src/renderer.cpp` clears `enhancementConfig.rect.fixRectLR` after `app_->setup(...)` (it must be after `setup`, which creates the shared queue resources `updateEnhancementConfig` writes through); `OGRE_RECT_LR_FIX=1` restores RT64's default for an A/B. Verified: the probe then reports `raw 1152,264..1176,292` / `vp w=6`, three dumps on the screen (`/tmp/ogre-fix-03/06/08.bin`, all three VI framebuffers) show column 294 as panel border on every glyph row where the pre-fix dumps show font ink, and the developer confirms the screen is fixed. `probe101` is reverted and `git -C tools/RT64 diff` matches `patches/rt64-ob64.patch` apart from the pre-existing dirty-plume line. **Tooling decision (same session):** the console's `snap [prefix] [ms]` writes the RDRAM image with the game threads parked plus RT64 present captures; it installs one static `OGRE_CAPTURE_PRESENT` entry with `putenv` at boot and toggles it by rewriting the first byte of the entry's **name**, because `setenv`/`unsetenv` would free the value string the present thread still holds and dereferences in the same present. | `app/src/renderer.cpp`, `app/src/sdl_platform.cpp`, `app/src/sdl_platform.hpp`, `app/src/main.cpp`, `docs/guides/app-build.md`; `/tmp/ogre-profile.bin`, `/tmp/ogre-auto-04.bin`, `/tmp/ogre-t2.bin`, `/tmp/ogre-fix-03/06/08.bin` and the run logs; the decoded display list at `0x80257E50` and the font sheet at `0x801FFCF8`; `docs/HANDOFF-2026-09-25-session101.md` |
| 2026-09-25 (100)    | **The v0.3.0 Linux package had no sound because the SDL2 linked into it had only the OSS audio driver, and SDL2's CMake drops a backend whose development headers are missing without failing.** The report is `[SDL] audio unavailable, running silently: dsp: No such audio device`; `dsp` is SDL2's OSS driver and `SDL_dspaudio.c:293` is that exact error string, reached only when no `/dev/dsp*` exists. `strings` on the released `ogrebattle64` shows `OSS /dev/dsp standard audio`, `SDL dummy audio driver` and `direct-to-disk audio`, and no `ALSA PCM audio`, `PulseAudio` or `Pipewire`. The mechanism was reproduced by configuring the repo's own pinned SDL2 2.32.10 in a bare `ubuntu:24.04`: without the audio `-dev` packages the built `libSDL2.a` defines only `DSP_bootstrap`/`DUMMYAUDIO_bootstrap`/`DISKAUDIO_bootstrap`, and with `libasound2-dev libpulse-dev libpipewire-0.3-dev` it also defines `ALSA_bootstrap`/`PULSEAUDIO_bootstrap`/`PIPEWIRE_bootstrap`. SDL2 prints `SDL_ALSA (Wanted: ON): OFF` in the configure summary and still exits 0, and `CMakeCache.txt` keeps `SDL_ALSA:BOOL=ON`, so **the cache and the summary are not a check — only the built archive says what was compiled in**. Fix: `make sdl2-static` asks for the three Linux backends, verifies the archive with the new `tools/check-sdl2-audio.sh` (which rejects `dsp` and names the per-distribution packages), and treats a cached archive that fails as not built, removing `tools/SDL2-static/{prefix,build}` and rebuilding; `tools/smoke-dist.sh` fails a Linux package whose binary carries none of the three; the hosted Linux CI step installs the three development packages; the self-hosted per-platform dependency table names them. No game, runtime or renderer code changed. Reference: Zelda64Recomp links the **system** SDL2 on Linux (`find_package(SDL2)`; the fetched prebuilt SDL2 is the Windows branch only), so it never met this failure. | `tools/check-sdl2-audio.sh` (new), `tools/smoke-dist.sh`, `Makefile` (`sdl2-static`), `app/src/sdl_platform.cpp` (the failure line now lists the compiled-in drivers), `.github/workflows/release.yml`, `docs/guides/app-build.md`; the v0.3.0 `ogre-battle-64-recomp-linux-x86_64.tar.gz` `strings`; the container builds (bare vs `libasound2-dev`+`libpulse-dev`+`libpipewire-0.3-dev`) and their `nm` symbol sets; `docs/HANDOFF-2026-09-25-session100.md` |
| 2026-09-25 (99)     | **The four N64 C-button masks are libultra's `CONT_C_UP/DOWN/LEFT/RIGHT` = `0x0008/0x0004/0x0002/0x0001`, the same values as the recomp frontend's `input_types.h`; `app/src/input_map.hpp` had them rotated one position, so a key labelled for one C direction produced its neighbour.** Developer report: *"it seems that the c buttons are mapped wrongly"* — observed `I → right, J → top, K → left, L → down`, expected `I → top, K → down, J → left, L → right`. The default key table already assigned `I/J/K/L` to the C-UP/C-LEFT/C-DOWN/C-RIGHT rows, so the fault was in the enum values (`N64_BTN_C_LEFT = 0x0008` and so on). The word must be in libultra order because `tools/N64ModernRuntime/ultramodern/src/input.cpp` `osContGetReadData` (line 178) writes the app's callback word straight into `osContPad.button`; `app/src/web_platform.cpp` forwards the JS word with no transform either, so `app/web/web.js`'s own `BTN` copy of the same rotated values was corrected with it. One change covers the keyboard poll, the fixed right-stick C layer, `OGRE_TAP_BUTTON`'s `cu/cd/cl/cr` and the launcher/overlay CONTROLS tab. A saved `controls.cfg` stores scancode names per button tag, so it needs no migration. Blast radius of the verification: the first pass ran `make app` and reported `build-app/ogrebattle64`, but `DIST_STATIC_SDL ?= 1` (Makefile line 425) sends `make app` to `build-dist/ogrebattle64` (line 500), so the developer's `./build-app/ogrebattle64` was a stale binary and still showed the old mapping; the environment change is `cmake --build build-app --target ogrebattle64`, now recorded in `docs/guides/app-build.md`. The four directions were not played back in a run; the constants pass a `static_assert` compiled with `input_map.cpp`'s own flags. | `app/src/input_map.hpp`, `app/web/web.js`, `tools/RecompFrontend/recompinput/include/recompinput/input_types.h` (upstream `N64Recomp/RecompFrontend` has the identical values), `tools/N64ModernRuntime/ultramodern/src/input.cpp:178`, `Makefile:425,500`, `docs/guides/app-build.md`; `docs/HANDOFF-2026-09-25-session99.md` |
| 2026-09-25 (98)     | **The escort mission's slow field is the session-80 class a third time: `func_ovlN_801D0B78`'s object-list scan carries an injected blocking `yield_self` at `0x801D0C08`, now listed in `yield_work_loop_branches`. A profile address is a function *entry*, so when several bank units share that RAM the address alone does not name the function — check the registration table and the run's DMA timeline first.** Developer report: *"during gameplay, it becomes slow during an escort mission (battery save attached)"*. The save is a 32768-byte raw `QuestOG3` SRAM image (SHA-256 `7bb8916399e9b682ebf4258119c7ef9c47e9f89ab9a83cc2d8a912c179b31ec6`) that resumes at scene `0x03` (descriptor `0x8018F350`, mask `0x0000038C`) through the title → `0x12` Load Game route — the session-67 *suspend* route, which streams units P/Q, not the natural route's unit R. Three profiled runs did not reproduce (100 s, 152 s, 187 s at p50 8 ms); the fourth did, in the seconds before the developer closed it: scene `0x03` display-list periods go from **8 ms to 80–183 ms for 2.6 s** (`t=57304..59921 ms`, no scene change, self-clearing), every `[prof] T=` line from `T=57000` puts the frame-pump thread `t4` in **`0x801D0B78`** (40 % → 64 % → **93 %** → 91 %, back to `0x80184214` at `T=61000`), and the snapshot repeats `[snap] hotloop t4: 0x801D0B78 x100`. The function scans the `-1`-terminated object-id list at `obj+0xA8` (`obj+0x80` is the caller's own id, `0x801F0CD0` is the id → object table): `sll/addu/lw $v1,0($v0)` for the entry, `bne $v1,-1` to exit, `lw $v0,0($s2); andi $v0,0x31` against `0x31`, and `bnel $v0,$v1,L_801D0BC4` with the delay slot `addiu $s3,$s3,1` on the skip path; the matching path computes a distance (`jal 0x8009C780`), mallocs a `w*h` scratch buffer (`jal 0x80070F30`), zeroes it and calls `func_ovlN_801D08A0`. The heuristic fired on the invariant-base loads and put `yield_self(rdram)` inside the taken side of the `bnel`, so it ran **once per skipped entry**; `yield_self` blocks for about one VI retrace, so a call costs (list length) × retrace, and the list length is mission state — hence the random onset and the self-recovery. **Bank ownership, which is the reusable part:** `0x801D0B78` lies in RAM shared by `kN_bankRec7`, `kJ_bankRec10a`, `kI_bankRec16`, `kAH_bankRec10s` and `kS_bankRec06`, so three checks were run before touching N: (1) `app/src/bank_funcs.inc` registers `0x801D0B78` exactly once, as `func_ovlN_801D0B78`; (2) run 4's last load into that RAM before the stall is `t=51984 ms rom=0x101D00 ram=0x801AD5C0 size=0x43530` (unit N's record 7), record 10 loaded only at `t=27638`/`46258`, and unit AH (`rom=0x23A370`) never loaded at all; (3) the wait exists only in unit N's generated code — unit AH has no `yield_self` site anywhere, and no other unit has one at `0x801D0C08`. The profiler's address is a function **entry**, because `debug_profile_start`/`debug_sample_hot_loop` read `last_func_vram[tid]`, which `recomp_trace_entry` writes (`tools/N64ModernRuntime/ultramodern/src/function_trace.cpp:717`/`:591`), so it names whichever bank's entry actually executed. Fix: `yield_work_loop_branches = [0x801B3008, 0x801DA2C0, 0x801D0C08]`; regeneration removes exactly one `yield_self` (50 → 49 tree-wide, `BankNFuncs/funcs_1.c` 4 → 3), and running `make recomp` with the old bank config leaves `RecompiledFuncs/` byte-identical, so the bankN key cannot touch the main unit. **Verified:** `check-banks` OK; `make elf-rom-check` 0 differing bytes for all 13 bank ELFs and the main ELF; bounded boot `runlog.py --check` PASS; fixed build, same save, 180 s and 44 scene transitions: `0x801D0B78` in **0 of 180** `[prof]` t4 lines (pre-fix 4 of 61) and the longest run of consecutive ≥ 50 ms frame gaps **20 → 2** (the two are the `0x03`→`0x02`→`0x0D` handoff, where 6–7 modules stream in); `[cover] 0x801D0B78 276` in the coverage census, so the scan still executes and only the wait is gone. Whole-run percentiles do *not* separate the builds (p50 8 / p90 12–13 / p99 34–35 ms on both); the gap-run tally and the profiler line are the discriminators. **Developer-confirmed:** the mission plays fast, and a second symptom of the same site — the slowdown that happened when opening the **list of units** — is gone too. That second symptom also gives the class a deterministic trigger: opening the unit list makes the list at `obj+0xA8` long, which is the same quantity the "random during the mission" slowdown scaled with. | `config/banks/config-bankN.toml`; `/tmp/ogre-lag-escort{1,2}.log`, `/tmp/ogre-escort3.log`, `/tmp/ogre-escort4.log` (reproduced), `/tmp/ogre-escort-fixed.log` + `/tmp/cover-escort-fixed.txt` (fixed), `/tmp/ogre-boot-fix.log`; `build/bankN.elf` `func_ovlN_801D0B78` disassembly + raw-ROM words `0x5443FFEE`/`0x26730001`; `app/src/bank_funcs.inc`; `tools/N64ModernRuntime/ultramodern/src/function_trace.cpp`; `docs/HANDOFF-2026-09-25-session98.md` |
| 2026-09-22 (97)     | **Every config the build reads lives under `config/`, and the upstream patches under `patches/`.** The repo root held 181 entries: 72 config files (`config.{yaml,toml}`, `config-bank<U>.{yaml,toml}`, `rsp-*.toml`), 27 symbol files (`symbol_addrs*.txt`, `reloc_addrs.txt`, `relocatable_sections.txt`, `extra_syms.txt`, the generated `undefined_{syms,funcs}_auto.txt`), 5 `*.patch`, 10 `.ogre-prefs-*` run sandboxes (400 MB of ROM copies), `.repro/`, `.DS_Store`, a tracked splat-generated `ogrebattle64.d` and the unreferenced pre-streamed-overlay `ogrebattle64.yaml`. The moves required path edits inside the configs because splat (`base_path = config_paths[0].parent / base_path`), N64Recomp (`config.cpp:296`) and RSPRecomp (`rsp_recomp.cpp:723`) all resolve a config's paths against that config's own directory: `config/config.toml` uses `../build/`, `../RecompiledFuncs` and `../assets/`; `config/config.yaml` sets `base_path: ..` and names `config/symbols/` for `symbol_addrs_path`, `reloc_addrs_path` and the two `undefined_*_auto_path` outputs that were previously splat's `base_path` defaults; each bank yaml sets `base_path: ../..` and names both symbol-file paths explicitly for the same reason; each bank toml uses `../../`. `ogrebattle64.{ld,d}` stay at the root (`-T ogrebattle64.ld`), and the `.d` is now gitignored. **Verified:** `make regenerate` from the moved configs exits 0 and leaves `asm/` and `ogrebattle64.ld` byte-identical; `RecompiledFuncs/` and the main ELF are unchanged; `make bank-recomp` (1m20s) passes `elfcheck --syms` and `check-banks`; the 11 bank units whose output changed (B..L) were each re-split from their `HEAD` config and re-linked, and all 11 ELFs hash identically to the moved config's; adding the explicit `reloc_addrs_path` changed no byte of the 186 generated bank files. **Finding:** the tree's `build/bank{B..L}.elf` were stale (linked from an older config content, so `make` never relinked them); the move forced the relink, which is why `Bank{B..L}Funcs/` differ from the pre-session tree, matching the session-87c trace-numbering note. `docs/HANDOFF-*.md` keep the old paths; this entry and the living docs carry the new ones. | `config/**`, `patches/**`, `Makefile`, `tools/{cross_bank,arenamap,n64map,guestmap,gen_bank_funcs,gen_bank_syms}.py`, `tools/release-build.sh`, `app/CMakeLists.txt`, `app/src/{bank_overlays.cpp,rsp.cpp}`, `.github/workflows/release.yml`, `.gitignore`, `README.md`, `AGENTS.md`, `PLAN.md`, `docs/README.md`, `docs/{symbols,scenes,LIBULTRA-BRIDGING,WEB-PORT-REPORT}.md`, `docs/guides/{app-build,linux-migration,rsp-microcode}.md`; `docs/HANDOFF-2026-09-22-session97.md` |
| 2026-09-21 (95)     | **The Esc overlay's new DEBUG tab shows the live Chaos Frame, and in this ROM the Chaos Frame is `0x801936C9` (u8), not the community figure `0x801936A9`.** The community source (ogrebattle64.net's Project64 recipe) gives `0x801936A9`, u8, default 50, range 0..100; in this ROM that byte has no static read or write in any linked ELF, it read 0 at the attract loop after a completed playthrough (where the Chaos Frame is 50), and it read 173/237 from the two endgame saves (outside 0..100). Three instruction-level checks name `0x801936C9`: the game-state initialiser `func_8016C900` bzeroes 58 bytes at `0x80193698` (`0x8016C928`/`0x8016C974`) and then stores **50** at `0x801936C9` (`0x8016C998`) — the documented starting value; the scene-`0x13` update `func_801B5128` loads that byte, masks it `0x7F` and stores it into the sprite it lays out (`0x801B5360`), the only flags-block byte the ending screen reads; and the scene-script VM's jump table `0x80190BC8` opcode `0xFF` stores a script operand there (`0x80171480`). Live `0x801936C9`: 99 with `last_perfect`, 100 with `last_low_chaos`, 50 at the title/attract. The panel change is also a decision: **the shared `ui::Panel` does not read guest memory** — the overlay samples the byte each frame in `draw()` and pushes it in with `Panel::set_chaos_frame()`, so the launcher (no running game) and the overlay share one implementation and the launcher's DEBUG tab says `GAME NOT RUNNING`. The DEBUG tab is enabled in Overlay mode next to CONTROLS/SETTINGS; `OGRE_OVERLAY_TAB=debug` opens it for a scripted run or a screenshot. The row prints the value and its ending band rather than the raw hex (developer): **`LOW` for 0-35, `NEUTRAL` for 36-64, `HIGH` for 65-100**. **Verified in one run:** with `last_perfect` on the battery, a map checkpoint (`save`/`load`) plus `OGRE_OVERLAY_TAB=debug` captured `Chaos Frame 99 HIGH` (`docs/proofs/native-overlay-debug-tab.png`) while the live console read `0x801936C9 = 63` hex in the same run; a title capture read `50 NEUTRAL`. **Not verified:** no automated run reached the scene-`0x13` screen, so the printed end-screen number was never compared with the byte in the same run (the suspend save in front of the final boss needs input through the last mission: with no taps it stalls at `t≈44 s`, and a continuous `A` tap drives the title's `Load Game` to the map instead). See `docs/HANDOFF-2026-09-21-session95.md`. | `app/src/game.hpp`, `app/src/ui.hpp`, `app/src/ui.cpp`, `app/src/overlay.cpp`, `docs/guides/app-build.md`; dumps `/tmp/last_perfect-map.bin`, `/tmp/last_low_chaos-map.bin`, `/tmp/credits-natural.bin`; `docs/proofs/native-overlay-debug-tab.png` |
| 2026-09-20 (94e)    | **The Windows access violation is in RT64's renderer setup on an old GPU; the backend is now selectable with `OGRE_GRAPHICS_API`.** Developer feedback: a player reports the first release worked, the developer's own Windows laptop fails on every release including that one, and the console-window build printed a **Vulkan workaround** line just before the crash. The code agrees. With a ROM present the app boots the game and RT64 creates its renderer on the gfx thread inside `recomp::start`; without a ROM only the launcher's SDL 2D renderer runs, which is why deleting the ROM lets the exe start — the failure is not a permission problem. The line is RT64's `Falling back to Vulkan due to device workaround.` (`tools/RT64/src/hle/rt64_application.cpp`), printed for an NVIDIA driver <= 475.14, an AMD driver <= Jan 2019, and Intel 6th-gen graphics <= 31.0.101.2115; the fallback destroys the D3D12 device and creates a Vulkan interface on the same window. Landed: `OGRE_GRAPHICS_API=<auto\|d3d12\|vulkan\|metal>` sets `userConfig.graphicsAPI` before `Application::setup` (otherwise hardcoded to `Automatic`), so `vulkan` skips the D3D12 attempt and the transition and `d3d12` is the other side of the A/B (RT64 still forces Vulkan for the listed broken drivers, so on those the useful test is `vulkan`); the shipped README tells a player to try both, and the knob table records the driver thresholds. The boot log already names `Device Name`/`Device Vendor`/`Driver Version` and whether the fallback ran, and the part-4 report adds the faulting module, so the next Windows report decides between RT64's own code (fault in `ogrebattle64.exe`), the driver, and the CRT. Verified on macOS: `OGRE_GRAPHICS_API=metal` logs the knob and initializes RT64 with api=3, the unset path is unchanged (`RT64 renderer initialized (api=3)`) | `app/src/renderer.cpp`, `packaging/README-dist.txt`, `docs/guides/app-build.md`; `OGRE_GRAPHICS_API=metal`/unset bounded runs, `/tmp/ogre-api/run.log`; `docs/HANDOFF-2026-09-20-session94.md` part 5 |
| 2026-09-20 (94d)    | **A Windows access violation on game start is still open; the crash report now carries the faulting module and address, the Windows handler uses no stdio, and a release can build Windows alone.** The developer's rc2 report: loading the ROM and starting the game dies with `unhandled exception 0xC0000005`, and restarting with the stored ROM dies the same way (deleting the ROM lets the launcher run). Both `error.log`s had a header, a non-null `rdram base` and then empty captured sections and an empty guest diagnostics section. Decisions landed for the hunt, not the fix: (1) the report prints `fault instruction` and `fault address` separately, each with its host module and offset (`GetModuleHandleExW`/`GetModuleFileNameW` on Windows, `dladdr` on macOS) and the `access` kind from `ExceptionInformation[0]`, and the RDRAM-relative offset when the address is inside the image; (2) `write_guest_diagnostics` writes the N64 thread and the last recompiled function per thread with raw writes on every platform, and **Windows uses no stdio in the handler at all** -- the runtime's printf-based call-chain dump is POSIX-only behind `ftrylockfile`, because a fault inside stdio hangs the handler and truncates the report (the class behind the part-2 macOS freeze); (3) `OGRE_CONSOLE=1` calls `AllocConsole` so a double-clicked GUI build shows the `[boot]` log, the switch Zelda64Recomp exposes as `--show-console`; (4) `tools/smoke-dist.sh` gained check 4: `OGRE_CRASH_TEST=segv` must leave an `error.log` containing the captured `[boot]` line, so an empty report fails the package; (5) `.github/workflows/release.yml` builds its matrix from a `plan` job and takes a `platforms` input (`all`/`windows`/`linux`/`macos`), so `gh workflow run release.yml -f tag=v0.2.1-rc3 -f platforms=windows` iterates in about 8 minutes; (6) Windows pins `SDL_AUDIODRIVER=wasapi` unless the player set it, Zelda64Recomp's workaround for the same runtime; (7) a `cl.exe` link gets `/OPT:NOICF` because identical code folding can merge two recompiled functions and the runtime patches a function's own code for a mod hook (clang-cl + lld-link does not fold by default). Zelda64Recomp's `preload_executable`/`VirtualLock` was read and not taken: it protects runtime code patching, and this crash happens with no mods loaded. Verified on macOS: the report has the new fields, `tools/smoke-dist.sh` passes with check 4, and the 45 s route run is `runlog.py --check` PASS; the rc3 Windows job exercises the Windows handler path | `app/src/{crash_log,main,sdl_platform}.cpp`, `app/CMakeLists.txt`, `tools/smoke-dist.sh`, `.github/workflows/release.yml`, `docs/guides/app-build.md`; `OGRE_CRASH_TEST=segv` report, `tools/smoke-dist.sh`, `runlog.py --check`, the `Zelda64Recomp/Zelda64Recomp` `dev` CMakeLists/main.cpp; `docs/HANDOFF-2026-09-20-session94.md` part 4 |
| 2026-09-20 (94c)    | **The Windows build died at the top of `main` because `setvbuf(stdout, nullptr, _IOLBF, 0)` is an invalid parameter to the MSVC CRT, and the release workflow now smoke-tests every package on the runner image that built it.** The developer: *"nothing happens in the windows version. nothing opens, no logs, nothing"*, then *"can we have a small smoke test in the os image that builds it?"*. The v0.2.0 `.exe` was sound (GUI subsystem, `WinMainCRTStartup` -> `WinMain` -> `main`, from its imported CRT entry markers), and a runner-side probe found the real cause: `crash_log::install()` (part 1) called `std::setvbuf(stdout, nullptr, _IOLBF, 0)` to keep `stdout` line-buffered once fd 1 became a pipe, and the MSVC CRT rejects a null buffer with size 0 as an invalid parameter; its invalid-parameter handler calls `_invoke_watson` and fast-fails the process (`0xC0000409`, faulting module `ucrtbase.dll`) before any of our handlers are armed. `cdb.exe` on the runner gave the stack (`ucrtbase!invoke_watson` <- `_setvbuf_internal` <- `setvbuf` <- `ogrebattle64+0x10e40` <- `WinMain`), and the plain run and an `OGRE_CRASH_TEST=segv` run both wrote no `error.log`, confirming the death precedes the handlers. glibc and macOS accept a zero size, so only Windows was affected. Fix: a static line buffer with a real size, plus `install_handlers()` before the capture setup. A second, independent defect came out of the new smoke test's static check: RT64 statically imports `dxcompiler.dll`/`dxil.dll`, and **both import `MSVCP140.dll`, `VCRUNTIME140.dll` and `VCRUNTIME140_1.dll`**, which the package did not ship, so a machine without the Visual C++ 2015-2022 redistributable cannot start the process (the runner has the redist, so a launch there cannot show it). Landed: `CMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded` for every Windows target (app, N64ModernRuntime, RT64), SDL2 built with the same setting plus a stamp guard, a POST_BUILD copy of the four runtime DLLs from `VCToolsRedistDir` beside the `.exe`, and a `dist` recipe that copies them and fails when one is missing. Separately, four early-exit paths (SDL init, game window, start-screen window and renderer) ended the process with no file and no dialog; they now call `report_boot_failure()`, which writes `error.log` and shows the reason, and `init_sdl` requires only video and events (audio and controllers are optional). The smoke test: `OGRE_SMOKE=1` exits 0 as soon as `main` is reached; `tools/pe_imports.py` requires every import of every shipped Windows binary to be shipped beside it or a system DLL; `tools/smoke-dist.sh` (`make smoke`) checks the companion files, runs the platform's import check and launches with `OGRE_SMOKE=1` under a deadline; the release workflow runs it on each matrix runner between packaging and collecting the archive. Verified: the macOS package passes `make smoke`; the v0.2.0 Windows zip fails the PE check naming exactly the four missing DLLs and passes once they are present; the v0.2.1-rc1 Windows job failed the smoke step on the `setvbuf` fast-fail; the 45 s route run is `runlog.py --check` PASS | `app/src/{crash_log,main,sdl_platform,launcher}.{cpp,hpp}`, `app/CMakeLists.txt`, `Makefile`, `.github/workflows/release.yml`, `tools/smoke-dist.sh`, `tools/pe_imports.py`, `packaging/README-dist.txt`, `docs/guides/app-build.md`; `cdb.exe` stack, `Get-WinEvent` crash signature, the v0.2.0 release zip, `make smoke`, forced `SDL_AUDIODRIVER`/`SDL_VIDEODRIVER` failures; `docs/HANDOFF-2026-09-20-session94.md` part 3 |
| 2026-09-20 (94b)    | **Closing the window is a hard exit, because the runtime never joins the game's threads, and the crash handler must not touch stdio.** The developer reported that the window freezes on its close button and needs a force quit. Reproduced by pushing the same `SDL_QUIT` the close button posts (the last window's `SDL_WINDOWEVENT_CLOSE` posts it; `src/events/SDL_windowevents.c`). `sample` and `lsof` on the frozen process: the main thread hung in `crash_log::flush` joining a capture thread whose pipe write end was still held, and an N64 thread was stopped in `__sflush` inside `fatal_signal_handler`, whose `error.log` recorded `SIGSEGV` with `fault offset from rdram: 0xE7A18`. Two layers. (1) `recomp::start` ended with `munmap(rdram)` while the game's threads — host threads that nothing joins, since `quit()` only sets `exited` for the runtime's own loops — were still running recompiled code, so the next guest access faulted inside the image. (2) The handler's `std::fflush(nullptr)` re-acquired the stdio stream lock the faulting thread already held, so it never returned, never re-raised, and the process never died; the old `bank_overlays.cpp` handler had the same pattern. Fix: `librecomp/src/recomp.cpp` frees RDRAM only when the run did not exit through `ultramodern::quit()` (landed in `n64modernruntime-ob64.patch`, regenerated and checked against a pristine `589bbf0`); `main.cpp` runs `overlay_shutdown`/`shutdown_sdl`, then `crash_log::flush()` and `_Exit(EXIT_SUCCESS)` rather than `return`, so the C++ static destructors never run with those threads live (`join_saving_thread()` is inside `recomp::start`, so the battery is still flushed before that); `crash_log.cpp`'s signal path never calls `fflush` and runs the `printf`-based runtime dumps only behind a non-blocking `ftrylockfile` probe, saying so in the report when they were skipped. Verified: a synthetic `SDL_QUIT` exits 0 in 5.49 s wall (teardown ≈0.49 s) with no `error.log`; a real System Events click on the close button exits 0; `open` + AppleScript `quit` exits cleanly; `OGRE_CRASH_TEST=segv` and a live `kill -SEGV` still write reports (the live one with the guest diagnostics section); the 45 s route run is `runlog.py --check` PASS; `build-app`, `build-dist` and `build-null` link | `tools/N64ModernRuntime/librecomp/src/recomp.cpp`, `n64modernruntime-ob64.patch`, `app/src/main.cpp`, `app/src/crash_log.cpp`, `docs/guides/app-build.md`; `sample`/`lsof` of the frozen process, `probe94` (added and reverted), `/tmp/ogre-quit*` logs; `docs/HANDOFF-2026-09-20-session94.md` part 2 |
| 2026-09-20 (94)     | **A distributed build shows no console window, and a crash writes `error.log` next to the save.** The developer: *"when we launch this game dist, a terminal window show up (with the logs) and the actual game window shows up later ... remove that first terminal window"*, and *"if the game crashes (due to finding some uncompiled code stub or a seg fault), it should create an 'error.log' file in the executable dir"* so players can file GitHub issues. macOS now ships `Ogre Battle 64.app` (`packaging/macos-Info.plist`, built by `make dist` and ad-hoc signed), so Finder launches it without Terminal; `SDL_FILESYSTEM_BASE_DIR_TYPE=parent` makes `SDL_GetBasePath` return the folder that holds the `.app`, so the ROM, `saves/`, `mods/`, `controls.cfg`, `settings.cfg` and `error.log` stay in the package folder and not inside the bundle. Windows links the `.exe` as a GUI-subsystem binary (`WIN32_EXECUTABLE`); that subsystem's CRT entry point is `WinMainCRTStartup`, which calls `WinMain`, so `main.cpp` supplies a `WinMain` forwarder for MSVC/clang-cl (MinGW's CRT already forwards, hence the `!defined(__MINGW32__)` guard), and calls `AttachConsole(ATTACH_PARENT_PROCESS)` so the `.exe` run from a terminal still shows the log while a double-click (no parent console) creates no window. `/ENTRY:mainCRTStartup` was tried first and rejected: clang-cl has no such driver option, so it was passed as an input file. The `[boot]`/`[bank]` log then had no console, so `app/src/crash_log.cpp` replaces it: `install()` runs at the top of `main()`, dups fd 1 and fd 2 onto two pipes drained into 128 KiB rings while every byte is forwarded to the real descriptor, and `stdout` is put back on line buffering, so a terminal run, `> run.log 2>&1` and `2> run.log` are all unchanged. It arms `SIGSEGV`/`SIGBUS`/`SIGABRT`/`SIGFPE`/`SIGILL` and `std::set_terminate` on POSIX, the same signals plus `SetUnhandledExceptionFilter` on Windows, and writes `<config dir>/error.log` (the executable's own directory unless it is read-only) with the reason, the fault address, the host pc, the last 200 stderr and 100 stdout lines — which carry any `[overlays] streamed function stub called @ …` or `[bank] UNCOMPILED streamed record …` line — and the runtime's guest call chain with fd 1/2 redirected into the file. Only the first report of a fatal event is written, so a `std::terminate` that then aborts does not overwrite it, and `OGRE_DUMP_RDRAM` still adds the 8 MiB image on the crash path. The old POSIX-only `on_fatal_signal` in `bank_overlays.cpp` was deleted so two handlers cannot fight over the same signals, and the runtime's `message_box` channel writes the file too. New knob `OGRE_CRASH_TEST=<segv\|bus\|abrt\|fpe\|ill>`. Verified on macOS: `make dist` produces the signed bundle; `open` of the bundle leaves Terminal's window count unchanged while the process runs; the bundle binary resolves `config path ok` and `error.log` to the package folder; `OGRE_CRASH_TEST=segv` and a `kill -SEGV` of a booted process both write the file (the second with the whole boot log and the live RDRAM base); `SIGTERM` writes nothing; and a bounded `> out.log 2> err.log` run keeps `[bank]` on stdout and `[boot]`/`[SDL]` on stderr with the last `[SDL]` lines drained before `_Exit`. Windows is code-verified only (no MSVC on this machine)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `app/src/crash_log.{hpp,cpp}` (new), `app/src/main.cpp`, `app/src/sdl_platform.cpp`, `app/src/bank_overlays.cpp`, `app/CMakeLists.txt`, `packaging/macos-Info.plist` (new), `Makefile` (`dist`), `packaging/README-dist.txt`, `docs/guides/app-build.md`; bundle launch and Terminal window count, `error.log` from a synthetic and a live crash, stream-separation run logs; `docs/HANDOFF-2026-09-20-session94.md`                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 2026-09-20 (93)     | **GAME SPEED is the runtime's emulated-clock multiplier (`OGRE_SPEED`) exposed as player data, offered as 1 / 2 / 4, changeable from the in-game overlay, and continuous when it changes.** The developer asked for a SETTINGS tab with one setting, `GAME SPEED [x] 1 [ ] 2 [ ] 4 [ ] 6 [ ] 8`, and — "only if that would be easy" — the ability to change it while playing from the `ESC` overlay; after playing at 6 and 8 they asked to drop those two because *"input doesnt work properly, too hard to aim the cursors"*, so the tab offers **1, 2, 4**. The values and the mechanism are the existing debug knob: `n` scales the emulated CPU counter **and** the VI retrace schedule, so a timed sequence completes in `1/n` of the wall time. Landed: `app/src/settings.{hpp,cpp}` holds the offered table, a main-thread-only live value, a tolerant `game_speed = <n>` parser and writer at `<config>/settings.cfg`, and `load_settings()`, which `main.cpp` calls next to `load_input_map()` before the game boots; `OGRE_SPEED` overrides the file for one run (and is not written back), and a file value the table no longer offers loads as the closest offered one (a stale `8` becomes `4`). `app/src/ui.{hpp,cpp}` gained `Tab::Settings`, `RowKind::GameSpeed` and the radio group: the group is laid out by a helper shared by `measure_panel` (row height) and `draw_panel` (markers plus one click rect per option, tested before the whole-row rect), so a click on a marker picks that speed and `LEFT`/`RIGHT`/`SPACE` step it; `tab_enabled()` now allows **CONTROLS and SETTINGS** in `Panel::Mode::Overlay`. `overlay.cpp` handles `LEFT`/`RIGHT` for the row, and gained `OGRE_OVERLAY_TAB` and `OGRE_OVERLAY_SHOT_MS` so a capture can show the changed value. `n64modernruntime-ob64.patch` adds `ultramodern::set_speed_multiplier()` (`timer.cpp`): the guest clock is piecewise linear, with `start_us`/`start_ticks` anchoring where the current multiplier took effect, so `osGetCount`/`osGetTime` and every pending `OSTimer` timestamp stay continuous across a change — without the anchors a 1 -> 4 change adds the whole elapsed run to the clock at once and fires every armed timer. The three anchor values are one snapshot published under a **seqlock**, and `get_speed_multiplier()` is a plain atomic load: the first version guarded the read path with a `std::mutex`, and the boot reached scene `0x09` at 7.3 s / 6.5 s at `OGRE_SPEED=4` against the pre-change binary's 6.1 s / 5.3 s; the seqlock version matches the pre-change binary within 50 ms on three alternating runs (3.94/3.91, 3.93/3.96, 3.96/3.91 s). **Verified:** `docs/proofs/native-launcher-settings.png` ([x] 1) and `native-overlay-settings.png` (the overlay's SETTINGS tab after a scripted `Right`, [x] 2); four scripted changes 1->2->4 in the overlay write `game_speed = 4`; the logged guest tick at each change equals the previous tick plus `elapsed_host_us * 46875 * previous_multiplier / 1000` exactly (3,181,474 us -> 149,131,593; +88,993 us at speed 2 -> +8,343,093), so the anchors are continuous and use the per-segment rate; a saved `8` loads as `4`; `OGRE_SPEED=1` with a saved `8` logs the override and leaves the file alone; a fresh config dir stays at speed 1 and writes no `settings.cfg`; the maintained 45 s title-route run (`OGRE_SPEED=4`) PASSes `tools/runlog.py --check`; the regenerated patch applies clean to a worktree of pristine `589bbf0`. **Open:** the tab has no reset row and no per-scene behaviour; audio at speeds above 1 is the pre-existing `OGRE_SPEED` behaviour (it was always tested with audio off); 6 and 8 remain reachable through `OGRE_SPEED`, where the overlay cannot show them selected.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `app/src/settings.{hpp,cpp}`, `app/src/ui.{hpp,cpp}`, `app/src/launcher.cpp`, `app/src/overlay.cpp`, `app/src/main.cpp`, `app/CMakeLists.txt`, `tools/N64ModernRuntime/ultramodern/src/timer.cpp`, `tools/N64ModernRuntime/ultramodern/include/ultramodern/ultramodern.hpp`, `n64modernruntime-ob64.patch`; `/tmp/ov3.log` (the four changes and their guest ticks), `/tmp/p1/settings.cfg`, `/tmp/pq/settings.cfg` (stale `8` -> `4`), `/tmp/pt-*` (alternating timing), `docs/proofs/native-launcher-settings.png`, `docs/proofs/native-overlay-settings.png`, `docs/HANDOFF-2026-09-20-session93.md`                                                                                                                                                                                                                                                 |
| 2026-09-20 (92)     | **The start screen is tabbed, the controller map is player data, and the in-game overlay is a layered window rather than an RT64 render pass.** The developer asked for a "controller input" tab in the launcher and for `ESC` to bring "the same content as the launcher" up over the running game, with ROM and MODS disabled and CONTROLS active, keeping the launcher's ASCII style; offered three overlay presentations they chose the **layered window** (a borderless always-on-top SDL window over the game), and for the game they chose **suppress input only** (it keeps running). Landed: `app/src/input_map.{hpp,cpp}` holds one row per N64 button (keyboard scancode + `None`/`SDL_GameControllerButton`/right-stick direction), defaults **identical** to the old hardcoded `keyboard_buttons()`/`gamecontroller_buttons()` in `sdl_platform.cpp`, persisted as `<config>/controls.cfg` and read on every input poll (a mutex-guarded copy; `ESC` is reserved and never bindable); the fixed right-stick C layer stays. `app/src/ui.{hpp,cpp}` holds `TextLayer`, the text helpers and a tabbed `Panel` (START GAME / ROM / MODS / CONTROLS; `TAB`/`SHIFT+TAB`/mouse switch tabs, `SPACE` activates, a binding row arms a capture that the next key or pad button fills, `BACKSPACE`/`DELETE` clear a slot) shared by the launcher and the overlay, so the two cannot drift; in `Panel::Mode::Overlay` only CONTROLS is enabled. `app/src/overlay.{hpp,cpp}` creates the overlay window lazily on the first `ESC` (`BORDERLESS|ALWAYS_ON_TOP|ALLOW_HIGHDPI|SKIP_TASKBAR`, sized and positioned from the game window, `SDL_SetWindowOpacity` 0.90 because SDL has no per-pixel alpha), draws it on the main thread from `update_gfx`, and `get_input` returns an idle pad while `overlay_visible()` is set. The event pump gained a one-time `SDL_NumJoysticks()` enumeration because the launcher drains SDL's `SDL_CONTROLLERDEVICEADDED` events before the game window exists (the start screen is shown whenever a mod is installed), which had left a pre-connected pad invisible. **Verified:** all four launcher tabs and the overlay captured (`docs/proofs/native-launcher-{start,rom,mods,controls}.png`, `native-overlay-controls.png`, written by `SDL_RenderReadPixels` through the new `OGRE_LAUNCHER_SHOT`/`OGRE_CAPTURE_OVERLAY` knobs); a scripted `Tab,Tab,Tab,Space,p` in the launcher and `OGRE_OVERLAY_AT_MS` + `Space,p` in the overlay each wrote `a.key = P` to a fresh `controls.cfg`; `[input] overlay open: game input suppressed` fired; `screencapture -R` with the overlay up shows it always-on-top at the game window's rect; a boot with the file present logs `[input] loaded`; the baseline boot timeline is unchanged (scene `0x09` 2305 ms, `0x0A` 11754 ms); `build-app` and `build-null` link. **Not verified:** gamepad capture with hardware (none on this machine), and compositing over the game's own pixels (the frontmost window during the capture was the browser). **Open:** the overlay does not pause the game, does not follow it into macOS fullscreen, and dims text with the same uniform opacity as the background.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `app/src/input_map.{hpp,cpp}`, `app/src/ui.{hpp,cpp}`, `app/src/overlay.{hpp,cpp}`, `app/src/launcher.cpp`, `app/src/sdl_platform.{hpp,cpp}`, `app/src/main.cpp`, `app/CMakeLists.txt`; captures `/tmp/proof-*.ppm` → `docs/proofs/native-launcher-*.png`, `native-overlay-controls.png`; `/tmp/ogre-ui/controls.cfg` (`a.key = P`) from both the launcher and the overlay; `/tmp/region.png`; `docs/HANDOFF-2026-09-20-session92.md`                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 2026-09-20 (91)     | **The mod system is enabled, the start screen owns the toggles, and a hook needed three runtime fixes on this port.** The runtime's mod support was already complete and `recomp::start()` already called `initialize_mods()` + `scan_mods()`, but `wait_for_game_started()` loads mods only when `GameEntry::mod_game_id` is non-empty and `app/src/main.cpp` never set it, so every `.nrm` was parsed and discarded. `main.cpp` now sets `MOD_GAME_ID = "ogrebattle64"` (`app/src/game.hpp`), scans before the start screen, and shows the start screen whenever at least one mod is installed so a shipped mod can be turned off (a vanilla install still boots straight in). `app/src/launcher.cpp` draws the start screen's list in three sections: **START GAME** (`[x] Start Game`; `[ ]` and not selectable until a ROM is loaded, and choosing a ROM returns here with it selected), **ROM** (`[x] Loaded!` plus the ROM file name, or `[ ] No ROM` plus `PRESS SPACE TO CHOOSE A ROM, OR DROP IT IN THIS WINDOW`; selecting it opens the file picker, so the screen works from the keyboard alone) and **MODS** (one row per mod with its `short_description` in a second column, then one row per visible option; the column wraps and the row grows to fit). Controls: `UP`/`DOWN` select (headings and an inactive START GAME are skipped), `SPACE` activates the row (START GAME plays, ROM browses, mod toggles, option steps), `LEFT`/`RIGHT` step an option, `ENTER` plays, mouse clicks activate. The old "click to load your ROM" prompt and the body hint are gone; the rows state both. `mods/skip-boot-logos/` is the reference example: a code mod whose single entry hook on the scene-`0x09` update `func_80177DCC` writes the title's id into the pending-scene word `D_800C4C26`, so the boot goes straight to the title (the battery is read before the first scene). Built by `make mod-syms` (`N64Recomp --dump-context` on the linked ELF, gitignored) + `make example-mods` (`tools/build-example-mods.sh`, MIPS gcc or Docker), shipped by `make dist` when present, and ships **off**: `mod.toml` sets `enabled_by_default = false`, so a fresh package plays the vanilla boot until the player enables it. The runtime already read `enabled_by_default` from `mod.json` (defaulting to true), but RecompModTool neither parsed nor wrote it, so `n64recomp-ob64.patch` adds the field (verified: a fresh config directory with only the `.nrm` logs `1 mod(s) installed`, no `Loading mod`, and the vanilla title at 28569 ms, with `[ ] Skip Boot Logos` in the start screen). **Verified:** true baseline (nothing in `mods/`) reaches the title at 27.7 s; with the mod the title is at 3.0 s and a swap-chain capture shows it rendering correctly (prologue text over the clouds). **The skip must come from scene `0x09`, not `0x0A`:** writing the word from scene `0x0A`'s update cuts the stills to one frame and the title then submits no display lists at all, leaving the last presented frame on screen (`0x0A`'s enter and leave touch overlay-C globals that only its completed 17-state machine leaves consistent); entering the title from `0x09` never runs `0x0A` and is correct. **First attempt kept for the record:** the mod shipped an `Enum` option choosing `Off` / `Publisher stills` / `Boot intro and stills` and hooked both updates; the developer removed it in favour of always skipping. Four runtime fixes, all in `n64modernruntime-ob64.patch` (which re-applies to pristine `589bbf0`): (1) a generated `RelocEntry.target_section` is the recompiler's ELF-section number (this port's code sections are 3/6/9/12/16 of 23) while `populate_reference_symbols` looks a function up by code-section position, so it found nothing and the mod failed with `Failed to load mod code (Code mod loading internal error)` — `context_from_regenerated_list` now translates the index; (2) a HI16/LO16 relocation against a section that holds no code is a data reference whose immediate is already absolute in this `use_absolute_symbols` project, and the runtime has no load address for such a section (`section_addresses` is zero), so regenerating it produced a load from address 0 and a store `0x80015E74` past RDRAM — those relocations keep their immediates; (3) macOS maps the executable's `__TEXT` `r-x` so `mprotect` fails `EACCES` and `vm_protect` returns `KERN_PROTECTION_FAILURE`, and `patch_func`'s write into a recompiled function died `SIGBUS` — `unprotect` now replaces the page with a private anonymous copy via `vm_remap(VM_FLAGS_FIXED\|VM_FLAGS_OVERWRITE)`; (4) the periodic `[snap]` queue snapshot converted 32-bit guest addresses with `TO_PTR`/`addr - 0xFFFFFFFF80000000` without sign-extending, so it dereferenced `rdram + addr + 0x80000000`, 4 GiB past RDRAM — it had always printed garbage (`count=-1996517056`) and the developer's packaged run died in `debug_dump_queue_snapshot + 0xF7` with `fault=0x221ae3b14 offset=0x1000E8B14`; it now sign-extends first (`to_host`), as `function_trace.cpp` already did, and the same snapshot reports `count=0/8` and `*ind=0x80177DA0` (scene `0x09`'s enter). **Open:** hooks are proven only in the base sections (`.entry`/`.main`/`.streamedA/B/C`); a hook inside a streamed bank unit is not covered by `get_vrom_to_section_map()` and is untested. | `app/src/main.cpp`, `app/src/game.hpp`, `app/src/launcher.cpp`, `app/src/launcher.hpp`, `mods/skip-boot-logos/**`, `tools/build-example-mods.sh`, `Makefile` (`mod-syms`, `example-mods`, `dist` copy), `.gitignore`, `packaging/README-dist.txt`, `docs/guides/app-build.md` → Mods, `n64modernruntime-ob64.patch`; runs `/tmp/ogre-baseline.log` (title 27687 ms), `/tmp/cap-e.log` + `/tmp/cap-e.360.ppm` (title 3021 ms, rendered), `/tmp/cap2-c.log` (stills cut, 35 display lists), `/tmp/cap-d.log` + `/tmp/cap-d.480.ppm` (`0x09` -> `0x04`, rendered), `/tmp/ogre-launcher-shot.png`; `RecompiledFuncs/funcs_1.c` `func_80177DCC` and `RecompiledFuncs/recomp_overlays.inl` relocs (`0xce54` ts 12, `0xce64` ts 16, `0xce74/78` ts 8); `tools/N64ModernRuntime/librecomp/src/mods.cpp`, `overlays.cpp`; `docs/HANDOFF-2026-09-20-session91.md` |
| 2026-09-20 (90)     | **The "Use Item" unit-command screen's lag is the session-80 class again: a second misclassified poll loop, fixed by listing one more branch in `config-bankN.toml`.** Developer report: *"the game becomes extremely slow when I'm in the 'use item' section, under 'unit commands'"*, reproducible in the tutorial. Developer-driven `OGRE_SPEED=4 OGRE_PROFILE=1 OGRE_DL_TRACE=1` run: scene `0x03` display-list periods jump from ~6 ms to **237–275 ms** at `t=137954 ms`, and every `[prof] T=` line from `T=138209` to the end puts the frame-pump thread `t4` in **`0x801DA248` at 99 %** (`[snap] hotloop t4: 0x801DA248 x100`). `func_ovlN_801DA248` (bank unit N, record 7) is a pure 10×5 table scan — outer bound `slti $a2, 0xA`, inner bound `slti $v1, 5`, 11-byte records at `0x801969D8`, **no `jal` and no store** — but `is_yield_poll_loop` accepted it because the body loads `lw $v0, 0($a0)` from the never-written argument base `$a0` (`0x801DA268`), a flag-bit test that is *not* the branch's condition (the branch tests an immediate bound). The injected blocking `yield_self` at backward branch `0x801DA2C0` ran on every iteration but the last — up to **nine** external messages per call, ~4.2 ms each at `OGRE_SPEED=4`, i.e. ~7 calls per frame = the measured 258 ms. Fix: `yield_work_loop_branches = [0x801B3008, 0x801DA2C0]`; regeneration changes **exactly one** generated file (`BankNFuncs/funcs_2.c`, 51 → 50 sites tree-wide, bank N 19 → 18), `check-banks` OK, boot timeline and `runlog --check` PASS unchanged. Verified on the fixed build: scene-`0x03` intervals **p50 8 / p90 14 / p99 34 ms, max 155 ms** (was p99 209 / max 275), **`0x801DA248` absent from every `[prof] T=` line**, present in the coverage census (1650 functions) so the screen was reached, and **developer-confirmed normal**. The same evidence names the next candidate, not fixed here: `func_ovlN_80204C08` (branch `0x80204C48`) has the identical shape, was 45–74 % of `t4` at the screen's onset, and spins at 44–51 % during ordinary mission play with no slowdown. *Reusable shape: read `t4`'s `[prof]` line, grep the function for `yield_self` in its bank's generated file, list the branch.*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `config-bankN.toml`; `/tmp/ogre-item-dev.log` + `/tmp/cover-item-dev.txt` (pre-fix), `/tmp/ogre-item-fixed.log` + `/tmp/cover-item-fixed.txt` (fixed), `/tmp/ogre-boot-fix.log`; `build/bankN.elf` `func_ovlN_801DA248` disassembly; `tools/N64Recomp/src/recompilation.cpp:516`; `docs/HANDOFF-2026-09-20-session90.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 2026-09-20 (89f)    | **`tools/release-build.sh` gated the zip on `zip` being installed, so the Windows package had no zip and the workflow's Collect step failed.** The run after 89e built and linked `ogrebattle64.exe` (`[701/702] Linking CXX executable ogrebattle64.exe`), bundled the DXC DLLs, and then failed with `##[error]dist/ogre-battle-64-recomp-windows.zip was not produced`: the script ran `make dist-zip` only when `command -v zip` succeeded, and Git Bash for Windows ships no `zip`, so the Makefile's `cmake -E tar` fallback from 89d was never reached. The gate now also accepts `cmake`, and the failure message names it. Verified on macOS with a PATH assembled to contain every tool except `zip` (the Windows runner's situation): `make dist-zip` alone writes a real ZIP, and the full `tools/release-build.sh` then produces both `ogre-battle-64-recomp-macos.tar.gz` and `ogre-battle-64-recomp-macos.zip` (`Zip archive data`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `tools/release-build.sh`; Windows job 106008565683 (build, link and DXC bundling succeed; Collect step fails), `/tmp/nzip` PATH-minus-`zip` runs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| 2026-09-20 (89e)    | **The Windows job builds with clang-cl under Ninja, not `cl.exe`.** The run after 89d passed SDL2, the app configure and the SDL2 package-directory fix, then died with **37 `cl : command line error D8021: invalid numeric argument '/Wno-unused-variable'`** — 36 for `ogrebattle64_recomp`, `ogrebattle64_rsp` and the 34 `Bank*Funcs` projects, plus one `/Wno-unused-parameter` for `ultramodern`. `cl.exe` reads `-W…` as `/W…` and errors rather than warning. clang-cl is Clang and accepts every flag the code uses, and it is the toolchain Zelda64Recomp's Windows job uses — `ilammy/msvc-dev-cmd@v1` for the MSVC headers/libraries/linker, `choco install ninja`, `-G Ninja -DCMAKE_C_COMPILER=clang-cl -DCMAKE_CXX_COMPILER=clang-cl`, `-DCMAKE_CXX_FLAGS="-Xclang -fexceptions -Xclang -fcxx-exceptions"` — so the Windows leg now uses it. Landed: the matrix carries `cmake_args` (empty off Windows) and the build step passes it as `CMAKE_ARGS`; `Makefile` forwards `CMAKE_ARGS` to the SDL2 and app configures; `app/CMakeLists.txt` adds the clang-cl exception flags and keys its flag groups on **`CMAKE_CXX_COMPILER_ID`, not `MSVC`** (CMake reports `MSVC` for clang-cl too, because it targets the MSVC ABI, so `if (MSVC)` would have stripped exactly the flags Clang accepts) and defines `NOMINMAX`/`WIN32_LEAN_AND_MEAN`; `n64modernruntime-ob64.patch` guards `-Wno-unused-parameter` the same way. Four Windows-only app compile blockers are fixed with platform branches: `create_window` returns `WindowHandle` (`{ HWND, thread_id }` on Windows) instead of the `SDL_Window*`; the checkpoint fingerprint's `<unistd.h>`/`readlink` becomes `_pgmptr`; `__attribute__((weak))` on `ogre_sync_framebuffers` is dropped for `_MSC_VER` (COFF has no weak symbols); and the POSIX `sigaction`/`siginfo_t` crash handler is compiled out. The Windows package now also carries `dxcompiler.dll` and `dxil.dll`, which RT64's CMake copies into `<build>/RT64` and loads at runtime (Zelda64Recomp ships both); without them the exe fails before the first frame. **Verified:** macOS builds with all the new guards pass (the Windows branches are inert), the regenerated `n64modernruntime-ob64.patch` applies to pristine `589bbf01` and reproduces the tree, and `make -n dist DIST_OS=windows` shows the DXC copy. **Not verified:** the Windows job has not run since; the clang-cl compile of the recompiled game code and RT64 is reasoned from Zelda64Recomp's working configuration                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `.github/workflows/release.yml` (`cmake_args`, `ilammy/msvc-dev-cmd`, `choco install ninja`), `Makefile` (`CMAKE_ARGS`, DXC copy), `app/CMakeLists.txt`, `app/src/sdl_platform.cpp`, `app/src/renderer.cpp`, `app/src/bank_overlays.cpp`, `n64modernruntime-ob64.patch`, `docs/guides/app-build.md` → Releases; Windows job log 106000439887 (`gh api .../actions/jobs/106000439887/logs`) with the 37 `D8021` lines; Zelda64Recomp `dev` `.github/workflows/validate.yml` `build-windows` and `CMakeLists.txt`                                                                                                                                                                                                                                                                                                                                         |
| 2026-09-20 (89d)    | **Releases publish, and each platform ships one correctly-named archive.** The release job ran `gh release create --draft`, so a green run left the archives invisible on the public Releases page; the developer asked for the per-platform downloads Zelda64Recomp shows (their releases are `draft: false` with one asset per platform). The job now creates the release published; `workflow_dispatch` gained a `draft` boolean (default false) for a review-first flow, a tag push always publishes, and a re-run that finds an existing draft publishes it with `gh release edit "$TAG" --draft=false` (the recipe in `gh release edit --help`). The collect step also had a naming bug: `tools/release-build.sh` writes both a `.tar.gz` and a `.zip` whenever both tools exist — macOS and Linux have both, and Git Bash now has `tar` plus the new `cmake` zip fallback — while the step copied each match to `matrix.archive`, so the zip overwrote the tar.gz and macOS/Linux attached **ZIP data under a `.tar.gz` name**. The matrix now names the flavour each platform ships (`.tar.gz` macOS/Linux, `.zip` Windows) and the step copies that one file, failing when it is absent. Verified locally: the collected macOS `.tar.gz` is gzip data, and the old loop left ZIP data at the same path                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `.github/workflows/release.yml`, `docs/guides/app-build.md` → Releases; `gh release edit --help` (`gh release edit v1.0 --draft=false`), `file` on the collected macOS asset and on the simulated old copy                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 2026-09-20 (89c)    | **The first hosted run after the CRLF fix reached `Build and package` on all three platforms and failed for three unrelated reasons, one per platform; each is fixed here.** Read from the job logs (`gh run view 35478117257 --log-failed`). **Linux:** the bundle in the private data repository carries AppleDouble `._*` members (`BankAAFuncs/._funcs_0.c:1:2: error: stray '\5' in program`, 9183 log lines of them). macOS `tar` writes those for files with extended attributes; they are metadata on macOS but ordinary files on Linux, and `app/CMakeLists.txt` globs `*.c`. `tools/data-bundle.sh` now runs `COPYFILE_DISABLE=1 tar --exclude '._*' …`, and the workflow's unpack step deletes `._*`/`.DS_Store` from any bundle, so the archive already in the private repository does not have to be rebuilt. **macOS (arm64):** `librecomp/rsp_vu.hpp` includes `<sse2neon.h>` under `__aarch64__`, and `ogrebattle64_rsp` — which does not link `ultramodern`, whose PUBLIC include dirs carry it — had no directory for it, so `audio_ucode.cpp` and `njpeg_ucode.cpp` failed with `fatal error: 'sse2neon.h' file not found`. The library now includes `N64ModernRuntime/thirdparty/sse2neon`. This development machine is **x86-64**, where `rsp_vu.hpp` takes the `<nmmintrin.h>` branch, so the missing include could never show locally; the arm64 runner is what exposed it. **Windows:** `cmake` on `windows-2022` selects the Visual Studio generator (the workflow installs `make` but no MinGW), which installs the static SDL2 as `SDL2-static.lib`, while the `sdl2-static` guard only accepted `libSDL2.a`; the recipe also built and installed **Debug** because it passed no `--config`, and SDL2's Debug name is `SDL2-staticd.lib`. The guard now accepts both names, build and install pass `--config Release`, and a failure prints the last 40 lines of `tools/SDL2-static/build.log` — the old message hid the CMake error and cost a round trip. The next run built SDL2 (`==> static SDL2 ready`) and failed one step later, in RT64's `find_package(SDL2)`: SDL2's CMakeLists sets `SDL_INSTALL_CMAKEDIR_DEFAULT` to `cmake` under `WINDOWS AND NOT MINGW` and to `lib/cmake/SDL2` elsewhere, while the Makefile's `-DSDL2_DIR` named the latter, so no `SDL2Config.cmake` was there. The Makefile now passes `-DOGRE_STATIC_SDL2=ON` and `app/CMakeLists.txt` checks both directories and sets `SDL2_DIR` before RT64 is added, so no Makefile-formatted path reaches CMake. Same commit: `dist` finds `build-dist/Release/ogrebattle64.exe` (a multi-config generator writes a per-config subdirectory) and `app` builds with `--config Release`; the app defines `SDL_MAIN_HANDLED` on Windows so `SDL.h` does not rename its `main` to `SDL_main` and demand SDL2main, and `init_sdl` calls `SDL_SetMainReady()` before `SDL_Init` (the documented pairing, and the reason SDL's `SDL_MainIsReady` guard cannot reject the call); `rt64-ob64.patch` now makes RT64 use the SDL2 that `SDL2_DIR` selects on Windows as on every other platform, because RT64 otherwise links its bundled win32-deps SDL2 (2.26.3, shared) against a window the app created with the SDL2 it links, and the package would need `SDL2.dll`; `dist-zip` falls back to `cmake -E tar --format=zip` because Git Bash for Windows ships no `zip`. **Verified:** a from-scratch macOS build of the committed tree plus these changes packages `ogre-battle-64-recomp-macos.{tar.gz,zip}`, including one configured with SDL2 installed in MSVC's layout (`-DSDL_INSTALL_CMAKEDIR=cmake`), whose configure prints `static SDL2: …/prefix/cmake` and completes; the regenerated `rt64-ob64.patch` applies to pristine RT64 `4337374` and reproduces `tools/RT64` file-for-file; `tools/data-bundle.sh` run with a planted `RecompiledFuncs/._probe.c` produces a bundle with 0 AppleDouble members; the RSP compile command now carries `-I…/thirdparty/sse2neon`. **Not verified:** the Visual Studio path past RT64's configure — the MSVC compile of the recompiled game code and of RT64 — has not been observed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `.github/workflows/release.yml`, `tools/data-bundle.sh`, `app/CMakeLists.txt`, `Makefile`, `rt64-ob64.patch`; `gh run view 35478117257 --log-failed`; failures `sse2neon.h` (macOS) and `stray '\5'` (Linux); `/tmp/hosted` from-scratch builds (exit 0, both archives), `/tmp/rt64-verify` patch check, `/tmp/bundle-test.tar.gz`; PLAN.md session-89c bullet                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 2026-09-19 (89b)    | **The Windows release job failed at the RT64 patch step because a Windows checkout writes CRLF into both `rt64-ob64.patch` and the RT64 tree, and `git apply` cannot match a hunk whose last line has no newline.** The job reported exactly two failures — `src/common/rt64_tmem_hasher.h:203` and `src/render/rt64_native_target.cpp:369` — which are **the only two hunks in the whole patch set** that carry `\ No newline at end of file` (`grep -c` = 2 in `rt64-ob64.patch`, 0 in the other five patches). Reproduced offline by checking RT64 out at `4337374` with `core.autocrlf=true` (CRLF tree, 371 CR lines in `rt64_native_target.cpp`) and applying a CRLF copy of the patch: the same two files fail and the other 21 apply. The other five patches apply with CRLF on both sides, which is why the earlier `N64ModernRuntime` step passed. Fix, both halves verified: root `.gitattributes` pins `*.patch` to `text eol=lf`, so the patch is LF in every checkout, and the workflow's `apply_patch` passes `--ignore-whitespace` to the reverse check and the apply, so a CRLF tree cannot break a hunk. Driven through the workflow's own function against that CRLF tree: first pass prints `==> applied`, second pass `==> already applied`, and the result is **byte-identical to the LF baseline for all 291 files** including the two missing final newlines (`tail -c 2` = `};`), so the idempotence check a self-hosted tree relies on still works. **Not verified:** a full Windows run; this machine reproduces the checkout but not the Windows build                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `.gitattributes` (new), `.github/workflows/release.yml` (`apply_patch`), `docs/guides/app-build.md` → Releases; `/tmp/ci3` CRLF-tree simulation (apply + re-apply + `shasum` vs `/tmp/base`), `git check-attr text eol -- rt64-ob64.patch` → `text: set`, `eol: lf`; PLAN.md session-89b bullet                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 2026-09-19 (89)     | **Releases can now build on GitHub-hosted runners: a private data repository hosts the recompiler's output as `files.tar.gz`, pulled in through the `OGRE_DATA_REPO` Actions variable and the `OGRE_DATA_TOKEN` secret. The repository's name is deliberately not recorded in this repository (developer, this session); the variable is its only reference.** Session 87b established that the generated C cannot be committed and that a hosted runner has no ROM to regenerate it from; the developer created the private repository and chose the generated-code payload over sending the ROM to CI. `tools/data-bundle.sh` produces the archive from a built tree (`RecompiledFuncs/` 21 files, 34 `Bank*Funcs/`, `RspFuncs/` 2 files, `app/src/bank_funcs.inc`, plus `ogre-data.txt` with the public commit; 188 entries, 7.5 MB, sha256 `d4478c02…` at commit `c6e03186`) and refuses to run when an input is missing (negative test in an empty root: exit 1, nothing written). `.github/workflows/release.yml` selects `matrix.hosted` when `OGRE_DATA_REPO` is set and `matrix.fallback` (the self-hosted labels) when it is not, so the existing self-hosted path is unchanged; the hosted path additionally clones and patches the runtime **and the two RT64 submodules** — `rt64-ob64.patch` (23 files, byte-identical to `git -C tools/RT64 diff` apart from the plume `Subproject commit …-dirty` line), `rt64-plume-ob64.patch` (`plume_metal.cpp`) and `tools/rt64-plume-sdl.patch` (`plume_vulkan.cpp`), the last of which is absent from this machine's tree because it only matters for the Vulkan path — plus guarded platform setup (Linux `libgtk-3-dev`/`libvulkan-dev`/`libx11-dev`, the macOS Metal toolchain probe, `choco install make` on Windows). **Verified offline:** both root patches apply cleanly to a fresh `N64Recomp/N64ModernRuntime` clone at `589bbf01` with submodules (`git apply --check`, then applied), and the patched clone is **byte-identical** to `tools/N64ModernRuntime` (`diff -r --exclude=.git --exclude=build` empty), so a hosted runner builds against exactly the tree the local build uses; the `apply_patch` helper applies each of the three RT64/plume patches to a pristine copy and reports "already applied" on a second pass; `actionlint`'s generated context-availability table confirms `vars` is allowed in `jobs.<job_id>.runs-on`. **Not verified:** a full hosted run — the Windows job was never executable on this machine, the Linux `plume_vulkan.cpp` patch has never been compiled here, and the runner images' package availability is taken from their READMEs                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `tools/data-bundle.sh`, `.github/workflows/release.yml`, `docs/guides/app-build.md` → Releases; `bash -n`, YAML parse, `dist/ogre-data/files.tar.gz` (188 entries) unpack test, `/tmp/n64mr-check` patch+diff, `/tmp/t-{rt64,plume}` apply tests; `docs/HANDOFF-2026-09-19-session89.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 2026-09-19 (88b)    | **Deferred: the Controller Pak copy/backup feature this menu offers (cartridge battery ↔ Controller Pak `Save`/`Load`/`Erase`) is out of scope for the port, and its remaining quirks are not bugs to chase.** Developer, after seeing the rendered screen: *"that screen allows copying saves from the battery into the controller pak, and the inverse. this is a pc port, so it's low priority. will not be fixed now."* So session 88's fix stands as "the scene renders and is the right screen"; the note-list content (`Note 1` / `Not an Ogre Battle 64 note.` on a freshly formatted pak) and the copy/erase flow are **knowingly left as-is**. A future session that wants them should treat them as a feature request, not a defect — the device half (`osPfs*` + flat 32 KiB `.mpk`, session 65) is already implemented, and the game's own save path is the battery, not this menu                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | developer statement (session 88); `docs/HANDOFF-2026-09-19-session88.md` §5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 2026-09-19 (88)     | **The boot-Start save menu (scene `0x18`) needs one more dispatched bank entry — `0x8019D67C` — and that alone fixes its black screen.** The developer: *"in the retail version of this game, if you hold start while it is booting, it allows you to access a special menu for saves. but in this version the screen is just black."* The boot branch is `0x800721DC`: `*(u16*)0x800E79B0 & 0x1000` (Start, the pad report the boot's own poll fills) → pending scene `0x18`, else the intro `0x09`. Scene `0x18`'s descriptor is **`0x8018FDC0`** (mask `0x2`), enter `func_8017BA60`, update `func_8017BB28`, hook `func_8017BB54`; its enter chunk-DMAs **unit H** (ROM `0x712A0` → RAM `0x8019A7C0`) and calls `0x8019D67C`, while the update/hook call `0x8019C69C` and `0x8019C4A8` (both already dispatched). `config.toml` extends `func_8019D568` to `0xCB0` (session 30's fall-through closure), which **swallows `0x8019D67C`**, so N64Recomp bound the `jal` at `0x8017BB04` to `func_8019D568` and emitted the redirect-plus-early-`return` shape: the enter returned before unit H's menu initialiser ran, the scene submitted no display lists, and every captured frame was `mean=0 max=0`. Decision: add `0x8019D67C` to `make recomp`'s `cross_bank.py dispatch --only` list (the sessions-55/60 mechanism) and leave the `func_8019D568` override in place, because `0x8019D67C` genuinely is that body's continuation and *the one call to it* is the site dispatched here. Result on the RT64 build with Start held (`OGRE_TAP_MS=150`): `[scene] id=0x0018` at `t≈2.4 s`, `[bank] loading overlay record rom=0x0712A0`, `func_ovlH_8019D67C` covered once, 436 display lists, 93/93 captured frames non-black (mean 83) — the **Controller Pak Menu** (`Save / Load / Erase / Exit`, `Game Notes`/`Pages`, note box), proof `docs/proofs/native-boot-start-controller-pak-menu.png`. **Correction to session 65 §9:** its "unread descriptor words `+0x14`/`+0x18`/`+0x1C` at `0x8018FDAC`" are scene `0x07`'s descriptor plus `0x14`, i.e. **scene `0x18`'s own descriptor** — there are no unread words, and `func_8017BB28` is scene `0x18`'s update, not scene `0x07`'s callback. Open lead: `cross_bank.py` has no detector for this shape (a size override that swallows a *bank function entry* which main-unit code `jal`s); the static detector from session 86 is the model                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `Makefile` (`recomp`'s `--only` list + notes); `config.toml` line 40 (the swallowed override, unchanged); `RecompiledFuncs/funcs_14.c` `@0x8017BB04` (`LOOKUP_FUNC(0x8019D67C)` + repaired delay slot); runs `/tmp/menu3.log` (pre-fix: scene `0x18`, 0 non-black frames) and `/tmp/menufix.log` (post-fix: 436 display lists, 93/93 non-black); `docs/HANDOFF-2026-09-19-session88.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 2026-09-19 (87c)    | **Regenerating the recompiled code is a first-class contributor path, and the order is load-bearing: `make regenerate` runs `resplit → link the ELF → bank-recomp → recomp → rsp-recomp`, and `make recomp` now refuses to run without the bank data its dispatch needs.** Verified by checking the *tracked* tree out into a clean worktree (exactly what a contributor clones, since the 62 MB of generated C is gitignored) and running the pipeline from nothing: it works, but **the documented recipe did not** — `docs/guides/app-build.md` jumped straight to `make recomp`, which needs the ELF that `make resplit`+`make` produce, and whose `cross_bank.py dispatch --only …` can only see bank records that `bank_funcs.inc` already lists. On a fresh tree that dispatch printed *"no bank entries registered yet (`make bank-recomp` not run); leaving --only target(s) undispatched"* and left **15 call sites bound to the wrong bank, silently, with a successful build** — the sessions-41/45/55 failure class; the fresh tree's `RecompiledFuncs/` hashed differently from the working tree for exactly that reason. Re-running `make recomp` once the banks existed produced a tree **byte-identical** to the one the project has been testing (`a3290e65…`), which is what makes the new `regenerate` target trustworthy. Landed: the `regenerate` target, a `recomp-prep` prerequisite that fails with the reason and the fix when `bank_funcs.inc` is absent (tested to fail on a pristine checkout and pass on a regenerated one), and a rewritten setup section in the guide that leads with regeneration. Two contributor traps documented: **`make resplit` always leaves `asm/1CE040.s`/`asm/40E80.s` dirty** (the committed files are the post-`fix-labels` form and the phony prerequisite re-patches them on every build — a patch round-trip, not a content difference), and **26 `Bank{B..L}Funcs/` files differ from a regenerated tree only in `recomp_trace_return` depth constants** (recompiler trace numbering moved after this tree's bank output was generated; filtering those lines leaves a zero-line diff, and they feed only the shadow call-chain diagnostic, so this tree's banks are functionally identical but not byte-identical to a fresh regeneration)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `Makefile` (`regenerate`, `recomp-prep`), `docs/guides/app-build.md` ("Regenerating the recompiled code"), `README.md`; clean-worktree runs (`make regenerate` exit 0; `recomp-prep` negative/positive); `docs/HANDOFF-2026-09-19-session87.md` §8 Addendum 2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 2026-09-19 (87b)    | **Cross-platform releases are built on a machine that has the ROM, because the recompiled code cannot be committed and GitHub-hosted runners cannot generate it.** `RecompiledFuncs/`, 34 `Bank*Funcs/`, `RspFuncs/` and `app/src/bank_funcs.inc` (62 MB) are the recompiler's output: gitignored, never tracked, and produced only by `make && make recomp && make bank-recomp` against a ROM. The developer asked whether committing them would put copyrighted code in the client, and the answer is that the generated C is a mechanical per-instruction translation of the ROM (`ctx->r5 = ADD32(0, 0X2);` beside `addiu $a1,$zero,0x2`) with no game data in it — but if a recompiled binary is a derivative work then so is that source, so **it was not committed** and hosted CI stays impossible until that policy changes (the workflow carries the hosted `runs-on:` labels in comments for the one-line switch). Landed instead: `tools/release-build.sh` as the single build entry point (checks the generated code exists and names the commands to produce it), `.github/workflows/release.yml` (tag `v*` → macOS/Linux/Windows matrix on self-hosted runners → **draft** release via `gh release create --draft`), `packaging/README-dist.txt` as the shipped player README, and a platform-generic `make dist` (`DIST_OS=macos\|linux\|windows`, `EXE_NAME`, `dist-tar`). **Building for Linux found four portability bugs that macOS had hidden, all fixed:** SSE4.1 was never enabled although `librecomp/rsp_vu.hpp` gates its SIMD path on `#if defined(__x86_64__)` and then calls `_mm_shuffle_epi8`/`_mm_blendv_epi8` (Apple clang's newer default `-march` happened to include them — `-msse4.1` now on `ogrebattle64_rsp` and `librecomp`, applied where each target is created, since the first attempt at the top level matched no target); `sdl_platform.cpp`'s `readlink` branch declared `const ssize_t n` colliding with the later `size_t n` of the fingerprint loop; `gbi.cpp`'s out-of-order designated-initializer array is rejected by GCC (now a switch); and Linux requested `SDL_WINDOW_VULKAN` unconditionally, so the *null-renderer* build — the variant for machines with no GPU driver — could not create a window (now behind `OGRE_USE_RT64`, with the macOS `SDL_WINDOW_METAL` flag). Verified in `ubuntu:24.04`: the null build runs launcher → ROM → boot → save written beside the executable; the RT64/Vulkan path initializes (`api=2` under Xvfb + Mesa `lavapipe`) then segfaults in the first frame — **undiagnosed, and possibly a software-Vulkan artifact** rather than a port bug. Windows remains written-but-unvalidated (no MSVC or mingw-w64 on this machine)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `app/CMakeLists.txt`, `app/src/sdl_platform.cpp`, `app/src/gbi.cpp`, `Makefile`, `tools/release-build.sh`, `.github/workflows/release.yml`, `packaging/README-dist.txt`; `docs/guides/app-build.md` → Releases; container builds (`/tmp/ogre-build-logs/{build,null,vk}.log`); `docs/HANDOFF-2026-09-19-session87.md` §8                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 2026-09-19 (87)     | **Distribution is a start screen plus an app-local config dir: the program asks for the ROM on first launch, stores it in its own folder, and writes the battery save *beside the executable*.** The developer's MVP: opening the program shows a black window reading `OGRE BATTLE 64: RECOMP` / `CLICK TO LOAD YOUR ROM (OR DROP IT IN THIS WINDOW)`, and running it creates the save file in the app's own directory. Landed as `app/src/launcher.cpp` (the screen: SDL2 window + `SDL_Renderer`, `SDL_DROPFILE`, nativefiledialog when RT64 is linked) and `app/src/font.cpp` (a built-in 5x7 ASCII bitmap font rasterised to a texture atlas, drawn into supersampled layers so the GPU downscale anti-aliases it — no font dependency, and the screen runs *before* RT64 exists). `main.cpp` resolves the ROM in this order: argument → `OGRE_ROM` → a ROM beside the executable (`find_exe_rom`, `ogre64.z64` and a `roms/` subfolder included) → the copy the runtime stored on a previous run → `assets/` (development) → the start screen. **The config directory is now `SDL_GetBasePath()`, not `SDL_GetPrefPath`** (new `resolve_pref_dir()`), which is what puts `<config>/saves/<game id>.bin` — the battery, 32768 bytes — in the executable's own folder, and makes a distributed package carry its saves; `OGRE_PREF_DIR` still wins (every scripted harness uses it and still works), and a directory that fails a write probe falls back to the per-user pref dir. **Clicking uses RT64's vendored nativefiledialog only when `OGRE_USE_RT64` is on** (`OGRE_HAVE_NFD`); the null-renderer variant keeps drag-and-drop and `OGRE_ROM` and prints the limitation on screen instead of growing a GTK dependency. `make dist` builds `dist/ogre-battle-64-recomp/` and `make dist-zip` packages it, and the package is a **single executable: SDL2 is linked statically** — `make sdl2-static` fetches a pinned real SDL2 (2.32.10) into the gitignored `tools/SDL2-static/` and builds it `SDL_SHARED=OFF`, because **Homebrew's macOS `sdl2` formula is `sdl2-compat`, a shim that `dlopen`s libSDL3 and ships no static library**; `otool -L` on the result shows only system frameworks, and SDL2's zlib license ships in the package (`SDL2-LICENSE.txt`). `DIST_STATIC_SDL=0 make dist` falls back to bundling the shared dylib (the `install_name_tool` path). Verified: the package launched from an empty folder shows the start screen (window capture), a synthetic drop (`OGRE_TEST_DROP`, a development hook that calls the same handler the `SDL_DROPFILE` branch does — *pushing* a fabricated `SDL_DROPFILE` through sdl2-compat dereferences a null string, so it must not be used) validates the ROM, boots RT64 (display lists), and writes `saves/ogrebattle64-us-rev1.bin` beside the executable; a second launch finds the stored ROM and skips the screen; an invalid path and a stored-ROM failure both show the runtime's own error on the screen. Open: the native file picker itself is code-verified only (a synthetic click needs macOS accessibility permission), and the on-screen error path was verified via the null build                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `app/src/{launcher.hpp,launcher.cpp,font.hpp,font.cpp,main.cpp}`, `app/CMakeLists.txt` (`OGRE_HAVE_NFD`, `nfd`), `Makefile` (`app`, `dist`, `dist-zip`), `.gitignore`; window captures of the start screen (repo build and isolated dist) and of the isolated-dir runs; `docs/HANDOFF-2026-09-19-session87.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 2026-09-19 (86)     | **`config.toml`'s `function_sizes` overrides must never run past the next *real* function's start or stop inside a function's own epilogue — every violation is a frame leak on the frame-pump thread, and the credits were four of them.** The credits screen (scene `0x11`) froze on its first beat ("Ogre Battle 64" logo) with `D_800AEFA4` frozen while `D_800C4BCC` counted (session 60's signature). Four session-41-class overrides were the cause, each found *statically* and fixed in `config.toml` alone: (1) `func_801AB76C 0x22C`→`0x4` — `0x801AB76C` is only the `addiu sp,sp,56` delay slot of `func_801AB568`'s `jr ra`, but the override ran to `func_801AB998`, so the real `func_801AB770` (ELF `0x228`, own prologue/epilogue) fell strictly inside and `func_801AB998`'s `jal 0x801AB770` (the credits text drawer) compiled as *call the containing body + early `return`*; (2) `func_801AB568 0x1E0`→`0x208` — the override cut the function's own epilogue (`lw ra/s7..s0`, `jr ra`, `addiu sp,sp,56` at `0x801AB740`–`0x801AB76C`), so the continuation `static_16_801AB748` took its delay slot from `func_801AB76C`'s range and **dropped it**, returning with `sp` `0x38` too low on every call (the `func_8019ABC4 = 0x368` pattern: extend *through* the epilogue); (3) `func_801B00D0 0x544`→`0x4` — `0x801B00D0` is `func_801AFC2C`'s `jr ra` delay slot and the real next function is `func_801B00D4` (ELF `0x540`), so `func_801B1BBC`'s `jal 0x801B00D4` (on the credits tree) was redirected into the placeholder and leaked; (4) `func_801AFC2C 0x4A4`→`0x4A8` — the ELF size stops one instruction short of its own delay slot (`addiu sp,sp,0x80`), dropping it and leaking `0x80` (session 41's `0x4A4` trim existed only to stop `jal 0x801B00D0` being redirected into it; that call is now dispatched at run time by the Makefile's `--only 0x801B00D0`, which rewrites it to `LOOKUP_FUNC`, so extending is safe — the recompile still reports `dispatched 0x801B00D0 (2 site(s))`). **The two static detectors, worth keeping:** a `jal 0xT` whose emitted call is followed by `recomp_trace_return(...); return;` *and* a duplicated delay slot (5 sites → 3, all latent), and a `// … jr $ra` immediately followed by `recomp_trace_return` with no delay slot emitted (2 sites → **0**). A call-tree audit (compare each `// 0xSRC: jal 0xTARGET` comment with the emitted callee's own `recomp_trace_entry` address) found the `func_801B1BBC → func_801B00D4` redirect. **Method correction: a forced `OGRE_SCENE=0x11` run does not execute the credits** — it plays the intro/opening (50/56 captured frames hash-match a plain boot) even when the trace reports `active=0x0011 done=1`, so only the natural ending validates this screen (developer corrected it twice). Verified on the natural route from a suspend save in front of the final boss (`assets/saves/suspend_final_boss.n64`, gitignored; `OGRE_SAVE=suspend_final_boss OGRE_SPEED=8`): `0x11` at `t=273613 ms` with continuous display lists (`30250 … 34400+`), `D_800AEFA4` tracking `D_800C4BCC` (`131988`), the fixed functions `func_801B1BBC`/`func_801B00D4` executing, then the Chaos Frame scene `0x13` (`t=328073 ms`) and the attract loop; 0 stubs/UNKNOWN; `make bank-recomp` `check-banks OK`, `make cross-bank-check` OK, both builds rebuilt. Developer-confirmed. Remaining: artifacts in the credit backgrounds; three latent leak-shaped `jal`s no route executed (notably `func_80079BD8`'s calls to **unit A**'s `0x801AB740`, which `cross_bank.py`'s `entry_looks_real` wrongly refuses as "not a function prologue" because the leaf starts with `lbu`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `config.toml`; `/tmp/credits-try2.log`, `/tmp/credits-try2-cover.txt`; ELF symbol sizes (`func_801AB76C`=4, `func_801AB770`=0x228, `func_801AB568`=0x1D8, `func_801B00D0`=4, `func_801B00D4`=0x540, `func_801AFC2C`=0x4A4) + raw-ROM disassembly; `docs/HANDOFF-2026-09-19-session86.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 2026-09-19 (85)     | **"Which streamed module does the port still lack?" is settled by two independent measurements at once — the runtime's own detectors *and* a diff of the whole DMA census against the registration tables — and the answer on every reachable path is now *none*.** The developer's ask ("locate code that wasn't recompiled yet, and compile it") is a hunt, not a static question, because a table-driven load has no loader `jal` to find (session 73's record 16, session 82's `0xE80` fragment). Method: two hand-played runs (`OGRE_DMA_TRACE=1 OGRE_DMA_TRACE_FULL=1`, `OGRE_COVER`, `OGRE_SCENE_TRACE=1`) — the first title → story → **tutorial `0x17`** → mission → Load Game → map, the second at `OGRE_SPEED=8` resuming the first run's battery through tutorial → **Organize `0x06`** → map → mission → battles — plus a `build-null` forced sweep of every scene id (`0x02,0x03,0x05..0x0D,0x0E..0x18,0x1A..0x1D`, 18 s each). Result: **0 `[bank] UNKNOWN module`, 0 `[bank] UNCOMPILED streamed record`, 0 `streamed function stub called`, 0 stub-microcode tasks**; every registered module executed ≥1 function in run 1 (session 83's two 0% modules, units T and U, now both execute); RSP tasks are only type 2 (`0x8009E050`, audio) and type 4 (`0x8009ED80`, njpeg), both recompiled. The offline half: every `(rom,ram)` pair from the three censuses (179 177 + 171 758 + 42 937) is checked against **both** registration tables (`app/src/bank_funcs.inc` + `RecompiledFuncs/recomp_overlays.inl`, via `tools/stubmap.py`'s model) for (a) unknown ROM at a **known module base** — the `UNKNOWN module` shape — and (b) an `0x200`-aligned, arena-addressed load whose ROM→RAM **delta matches a known arena** but whose base is unknown — the record-16 shape; both are **0**. Everything else landing inside a known module's RAM span is an asset/scratch DMA (record 14's arena and scene `0x0F`/`0x16` buffers are DMA targets), not code. **The battle is a mission sub-state, not scene `0x0E`** (unit `X` and the `AH` setup fragment load while `active=0x0003`), and the closing movie's unit `I` loaded cleanly under the forced `0x16`. So nothing is compiled because nothing is missing, and the only "not compiled" backlog left is **static and latent**: `stubmap`'s 129 missing-function candidates (a bank opens with a prologue at the address but has no table entry) and 288 indirect `jalr` sites — none fired a stub in ~2 h of emulated play plus a full scene sweep, so a future session must treat them as a hardening pass, never a bug hunt. Two hunt-diagnostic bugs were fixed: **`OGRE_SCENE_TRACE` walked `*(0x801B81D0)` and `*(0x801B84AC)` with no bounds check**, so at the title → story `0x0B` handoff (where the word is stale/wild) it died with SIGBUS inside `RT64Renderer::update_screen` (session 36's `poll_scene` bug, in a diagnostic) — both are now only walked when they are KSEG0 pointers whose window fits in the 8 MiB RDRAM, verified by a 40 s `OGRE_SPEED=8` run that now reaches `0x0B` and exits 0; and the **window-close path now calls `dump_dma_trace()`** (it was only on the `OGRE_EXIT_AFTER_MS` path, so a hand-played hunt — the intended way — lost the census), exactly as session 83 added for `cover`. Open: a teardown crash `func_8007F8E4 + 0x2F8` **after** the census dump on window close, reproducible in both runs. **Hunt ergonomics, recorded:** use `OGRE_SPEED=8` for hand-played hunts, and reuse the previous run's `OGRE_PREF_DIR` battery to resume progress instead of replaying the tutorial                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `app/src/main.cpp`, `app/src/renderer.cpp`; `/tmp/ogre-hunt.log` (533 005 lines) + `/tmp/ogre-hunt2.log` (53 MiB) + `/tmp/ogre-sweep-*.log`; `tools/stubmap.py` module model; `docs/HANDOFF-2026-09-19-session85.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 2026-09-18 (84)     | **The attract story's olive background is one branch on one word, and the port reads code where retail reads data — it is not a renderer bug.** The developer's report (scene `0x0B`, the "lore history" attract story) reproduces: the top and bottom bands of the 320x240 target sample `(74,90,0)`, and `OGRE_FBRENDER_TRACE=1` names the draw — `FillRect fillColor=0x4AC14AC1 rect=(0,0)-(1276,956)`. `0x4AC1` is RGBA16 `R9 G11 B0`; its `SETFILLCOLOR` is in the game's own display list (live RDRAM `0x802BA3C0`, and it is the *only* `4AC1` fill in the whole 8 MiB image). The colour is an immediate at ROM `0x0EEBE0` = guest `0x801A1E80` in **record 3**, and its bytes agree in the raw ROM, in `bankA.elf` and in the generated C — so the *code* is faithful. The instruction is the delay slot of a two-way branch (`0x801A1E70`–`0x801A1E84`) on `v1 = *(0x80197C88 + 12*(u8)0x800E7AB8)`: bit `0x2000` or `0x1000` set → `a0 = 0x4F00C308` (RGBA16 `(0,24,24)`, the near-black retail shows); both clear → `a0 = 0x4AC1` (olive). **`0x80197C88` is inside record 2's *code* span** (`0x80197B90..0x8019E1A0`), so the port reads record-2 ROM bytes there: `0x10400009`, both bits clear → olive. A reference savestate (`~/Documents/RetroArch/states/ParaLLEl N64/…state`, RZIP: 129 zlib streams with 4-byte LE length prefixes, `MEM ` RDRAM at state offset `0x1B8`; same ROM MD5) has `0x00021603` — bit `0x1000` **set** — and holds a runtime-built 12-byte-stride table there, not code. **Caveat, load-bearing for the next session: that state is scene `0x0A`, not the attract story**, so it proves "retail leaves data with `0x1000` set at `0x80197C88`" but not the attract value. A temporary probe (`probe84`, reverted) on `recomp_mem_addr` logged every access in the table window with `dladdr`-resolved writers: `func_80071EB0+0x9A9` reads it once, `pi_perform_dma` writes the record-2 DMA over it, and **nothing in the whole 30 s attract run writes it after that** — so the deciding word is code and no resident code populates it. `OGRE_FOG=0`, a 1× and an 8× run all show the band (not the fog repair, not speed), and `OGRE_SCENE=story` does not (a forced entry lacks the pre-state). No code, config or generated output changed. **Follow-up evidence (developer-corrected): the bands are the game's own 4:3 letterbox, and retail paints them black.** The two arms differ only in colour and both are now known: the port's bands measure **`(74,90,0)`** — exactly the `0x4AC1` arm, RGBA16 `(9,11,0)` expanded `(v<<3)|(v>>2)` — while the other arm's `0x4F00C308` carries the colour half `0x00C3` = **`(0,24,8)`**, the visually-black value retail shows. The band colour is identical in every attract-story frame captured (`a2.504`..`a2.1090`), so it is a stable state and no renderer/palette question remains; only *which data the branch reads* is open. The earlier reference figure `0x00021603` is **withdrawn** (the RDRAM base offset in the RetroArch `ParaLLEl N64` RZIP state could not be derived reproducibly). Next: compare `*(0x80197C88)` and `0x800E7A36` against a readable `Mupen64Plus-Next` state                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `docs/HANDOFF-2026-09-18-session84.md`; live RDRAM + `[fbrender]` traces; ROM `0x0EEBE0`; `BankAFuncs/funcs_0.c:26168`; reference savestate RDRAM                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| 2026-09-18 (83)     | **The remaining "missing stub" whack-a-mole is a *static* question, and the answer must be read from the runtime's registration tables — not from the generated C.** `tools/stubmap.py` enumerates every `jal` in `RecompiledFuncs/` + `Bank*Funcs/` (the generated comments carry both the `jal` address and its target) and classifies each dispatched address against what `get_function` can actually resolve: `func_map` is filled **only** by the main ELF's section table (`RecompiledFuncs/recomp_overlays.inl` — which is also the only place a *reimplemented* function such as `osSetIntMask_recomp` has an entry, since it has no generated body; parsing the C definitions drops it and reports a false gap) and by the bank records in `app/src/bank_funcs.inc` (what `on_streamed_dma` registers). Buckets, strongest first: **DEFINITE** (no module registers the address at all — no run state can resolve it — or the caller's own resident bank has no entry inside its own DMA'd code), **MISSING FUNCTION** (a bank that can be resident has a real prologue in its own ROM bytes there but no entry: a split cannot see an indirect-only function), **BANK SELECTION** (the missing bank's bytes are a body interior; which bank of an arena is resident is scene data), **INERT** (the scene-descriptor record masks say the missing bank's record is never loaded with the caller's — the `cross_bank.py check` model), plus UNRESOLVABLE and the RSP-IMEM window `0x84000000`. Ownership for dispatch is the **code half** only: a module's BSS span is where the *other* banks of the arena load (record 14's chapter modules at `0x8022ACB0`/`0x802395E0`), so counting it as an owner both hides real gaps (session 82's `0x801D1508` hides inside record 10's BSS range) and invents false "the caller's own bank" ones. **A run log is still the arbiter for a hit**, and the tool closes that loop without extra instrumentation: the runtime already prints the live first words at a stub address (`[overlays] @0xADDR: …`), so `stubmap.py log` matches them against each candidate module's ROM image, names the module that *was* resident, and says which bug it is — resident-but-unregistered (a load that missed `on_streamed_dma`) or wrong-layout dispatch (the address is a body interior in the resident bank). Current build: **985 static targets, 0 definite, 0 unresolvable, 129 missing-function candidates, 152 bank-selection candidates, 369 inert, 332 resolvable** — every static `jal` target is registered by some compiled module, so what is left is `jalr` (288 indirect sites, reachable only via data pointers — `stubmap.py pointers`) or a bank with no record. Replayed against the pre-session-82 tree the tool marks `0x801D1508`/`0x801D0AAC` DEFINITE (the bug it was built after); on `ogre-s73-r5.log` it names record 16/unit AG and on `ogre-live4.log` record 9ab/unit AB as the resident module behind a stub burst. **"Recomp %" is likewise four numbers, not one, and `tools/recompcov.py` measures them:** code bytes (99.05% of the ROM code span `0x001000..0x2B8B70`, the single `0x6990` gap being data), modules (28/28 loader-pattern arenas; 44 records/34 units; 5037 entries / 4963 addresses), dispatch (985 static targets, 0 unresolvable; 288 `jalr` sites unmeasurable offline), and **execution coverage per run** — the only one that needs the game, because executed-ness is not a property of the build. The runtime already counted every function entry for `OGRE_PROFILE` but printed only the per-second top 8; the counter's keys are never cleared, so its occupied slots *are* the executed set, and `OGRE_COVER=1` now dumps it (exit path **and** window close **and** the live console's `cover`). A coverage run must not pay for the call-chain hooks, so `heavy_traces_enabled()` splits them out (without the split the run crawled: 62 s of emulated time in minutes of wall clock, versus 134 s in 180 s after). **A session played by hand is the intended measurement**: `OGRE_COVER=1` with no taps and no `OGRE_EXIT_AFTER_MS`, closed when done — scripting a coverage run with taps leaves the window idle and an exit timer kills it mid-play (both observed). The first route (boot → Load Game → map → mission) executes **1593/4963 = 32.1%** with 0 stubs and 0 UNKNOWN modules, and its 8 entered-but-unregistered addresses are `cross_bank.py`'s direct-call backlog observed executing — the two tools measure the two halves of the same thing. **The measurement worth having is a hand-played session**: one full mission entered 2213 functions, **2205/4963 = 44.4%**, and left exactly **two modules never entered at all** (unit T's `bankRec18b`, 54 functions, and unit U's `bankRec18c`, 7) — a 0% module is definitive evidence of "untested", whereas a module that shares RAM with a sibling bank can only be an upper bound (siblings register the same addresses, so an executed address credits every bank that lists it; the tool marks those `[s]` and the run's `loading overlay record` lines are what name the resident bank)                                                                                                                                                                                                                                                      | `tools/stubmap.py`, `tools/recompcov.py` (new); `Makefile` (`stubmap`, `stub-check`, `recompcov`); `docs/guides/app-build.md` (Diagnostics toolkit, console `cover`, `OGRE_COVER`); `app/src/main.cpp`, `app/src/sdl_platform.cpp`; submodule `tools/N64ModernRuntime` (`function_trace.cpp`, `ultramodern.hpp`) via `n64modernruntime-ob64.patch`; pre-fix replay + `ogre-s73-r5.log` / `ogre-live4.log` attributions; `/tmp/cover-run2.log` (1593/4963, 0 stubs); `docs/HANDOFF-2026-09-18-session83.md`                                                                                                                                                                                                                                                                                                                                              |
| 2026-09-18 (82)     | **A rare gameplay event is reproducible without luck: decode its trigger from the ROM and force the branch, then read the run log.** The developer's **neutral encounter** (wild monster on the mission field) displayed its message, entered the battle and won instantly with **no enemy**. The trigger is decodable: `func_ovlN_801E7940` (unit N, mission record 7) runs every frame in mission **state 0** (`0x801af34c`, table `0x801EDC60`), takes a field unit matching `(unit[0] & 0x60011) == 0x40011`, rolls `rand() % 72000 <= 50` (10 when `func_80186230(17)` is false — the "revisiting" case), reads the terrain byte under that unit and indexes `0x801ED780` (terrain → group) and `0x801ED79E` (group → class, row `0x801E7E38 + mission*12` − 3, stride 20), storing **`class + 0x100`** at `0x801F0E24` — which reproduces the GameFAQs guide's entire table set. Patching the two probability branches (tag `probe82`) makes the event fire on demand. The failure was then two log lines: `[bank] UNKNOWN module rom=0x23A370 ram=0x801D0860` + `streamed function stub called @ 0x801D1508`. Scene `0x0E`'s enter (`func_80177754`; the same loader/`jal` arm in scene `0x0D`'s enter) streams a **setup fragment** (ROM `0x23A370`, `0xE80` → RAM `0x801D0860`; code `0xE70`/data `0x10`) whose `func_801D1508`/`func_801D0AAC` build the battle's participant table; the port had no record, so the wild unit was never created. Normal battles still worked because their units already exist on the field. Fixed as **bank unit AH** (`bankRec10s`, one more bank of RAM `0x801D0860`, sibling of units J and I, three forced entries `0x801D0860`/`0x801D0AAC`/`0x801D1508`). **`tools/arenamap.py` had listed this fragment since session 73 as "1 uncompiled … no observed run streams" — the tool was right, the route coverage was not; a scene's setup module only streams on the path that reaches that scene.** Developer-confirmed ("it worked"); proofs `docs/proofs/native-neutral-encounter-message.png`, `-battle.png`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `config-bankAH.yaml`/`.toml`, `symbol_addrs-bankAH.txt`, `Makefile`, `app/src/bank_funcs.inc`; `tools/elfcheck.py --syms` (bankAH 0/2339312 differing bytes), `tools/cross_bank.py check-banks` OK; `docs/HANDOFF-2026-09-18-session82.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 2026-09-18 (80)     | **The fix for a misclassified poll loop is a *declarative per-site override*, not a change to the heuristic: `config-bankN.toml` gains `yield_work_loop_branches = [0x801B3008]`, and N64Recomp emits no `yield_self` at a listed backward branch.** Session 79 left the mission's post-battle lag diagnosed but unfixed: `is_yield_poll_loop` (`tools/N64Recomp/src/recompilation.cpp`) classified the mission's nearest-target search `func_ovlN_801B2F4C` as a poll loop because a body load (`lwc1 $f2, 8($s0)`) has a loop-invariant base, and the injected blocking `yield_self` then cost the frame-pump thread ~one VI retrace per entity. Every broad repair (three attempts) deadlocked the boot, so the correction is scoped to the one branch that is provably a work loop: the loop terminates on a list element loaded from an address it advances (`lw $v0, 0($v0)` with `$v0 = $a0 + $v1`), not on a fixed location. Mechanically the option flows config → `Context::yield_work_loop_branches` → the top of `is_yield_poll_loop`, so the rest of the heuristic is byte-for-byte unchanged and **the generated tree changes in exactly one file** (`BankNFuncs/funcs_3.c`, the single `yield_self(rdram);` line removed; 52 → 51 sites; all 144 other generated files identical by SHA-256). Because the branch is in bank unit N (the mission module, record 7) and is not resident during boot, the change cannot alter boot behaviour — verified anyway: the scene timeline through the boot is unchanged (intro `0x09` → publishers `0x0A` → title `0x04` → tutorial `0x17` → new-game `0x02`/`0x0D` → mission `0x03`). **Developer-confirmed fixed**: driven to a battle on the tutorial-practice route at `OGRE_SPEED=8`, the mission runs normally ("it runs perfectly"); the same route previously collapsed to 1.4 display lists/s. The log (`tools/run-lag.sh --tag s80mission`, `OGRE_PROFILE=1`) has **0 seconds at ≤12 display lists/s**, 0 occurrences of `0x801B2F4C`, and p50 6 ms / p99 31 ms display-list intervals over 129 s and eight mission crossings. *This is the general shape to reuse for any further misclassified loop: list the branch, do not weaken the heuristic.*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `config-bankN.toml`; `tools/N64Recomp/src/{config.h,config.cpp,main.cpp,recompilation.cpp}`, `include/recompiler/context.h`; `n64recomp-ob64.patch`; `docs/HANDOFF-2026-09-18-session80.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| 2026-09-18 (79)     | **A recompiler-injected `yield_self` is a *blocking sleep*, so emitting it in a loop that does work costs one external message (about one VI retrace) per iteration — the mission's post-battle lag is one such site, and it is the frame-pump thread itself that blocks.** Developer report: after a battle, when an enemy unit's destruction effect ends, the mission (scene `0x03`) "draws and responds, just very slowly". Measured with `tools/run-lag.sh` (`OGRE_DL_TRACE=1 OGRE_SCENE_LOG=1`): submitted display lists go from 33 ms apart to ~717 ms (**30 → 1.4 lists/s**) at the onset, while `processDisplayLists` stays at 4–6 ms and the log shows **0 `streamed function stub` and 0 `UNKNOWN module`** — so the renderer and the bank map are healthy and the game thread is *waiting*. `OGRE_PROFILE=1` + `tools/proflog.py --names` puts the frame-pump thread `t4` in **`0x801B2F4C` for 93–96 % of the slow seconds**; that function is the mission module's (bank unit N) nearest-target search, and `BankNFuncs/funcs_3.c:55419` carries `yield_self(rdram);` at the loop's backward branch (`0x801B3008`), i.e. **once per candidate entity**. `yield_self` = `wait_for_external_message()` + `check_running_queue()` (`ultramodern/src/scheduling.cpp`), and the wait blocks until an external message arrives (≈ one retrace, 16.7 ms), so a ~22-entity scan costs 0.4–0.7 s per frame. N64Recomp's `is_yield_poll_loop` accepts the loop because a load inside it (`lwc1 $f2, 8($s0)`) uses a base register written once at function entry — genuinely loop-invariant, but the loop is not a poll loop. **Three candidate repairs were built and every one stalled the boot** (scene `0x09` produces one display list and `t4` sits `BLOCKED on recv of queue 0x800C4C28`): (A) emit `yield_self` only for loops with no interior conditional branch (52 → 7 sites); (B) same classifier but a new non-blocking `yield_self_nowait` (`wait_for_external_message_timed(..., 0)`) for the work loops (7 blocking + 37 nowait); (C) keep the original emission but fix the heuristic's register bookkeeping (`load_written[base]`, and cop1 loads write `ft` not `rt`) (52 → 44 sites). Conclusions recorded for the next session: **`yield_self` is also the only external-message pump a running thread has**, so a repair must keep pumping; **a non-blocking pump is not sufficient** (either something in the boot needs the block, or the message that matters is produced only while the thread is parked — undetermined); and the register bookkeeping is more load-bearing than it looks. All three were reverted and the tree/`tools/N64Recomp` are back at the recorded baseline, so **no functional change is landed**; the next step is the scoped experiment on the single site plus a scheduler-ring comparison                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `docs/HANDOFF-2026-09-18-session79.md`; `tools/run-lag.sh`, `tools/proflog.py`, `tools/symlook.py` (new)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 2026-09-18 (78)     | **A battery slot's two header checksums are seeded with the slot's own device offset, so save data is valid only in the slot it was checksummed for — which is why a Controller Pak note is not directly loadable.** `func_8007541C` validates slot `n` as `memcmp("QuestOG3", slot+4, 8)` **and** `u16[+0x00] == checksum_sum_seeded(slot+0x0C, 6212, 0x10 + n*0x1850)` / `u16[+0x02] == checksum_bits_seeded(same)` — the sum of the region's bytes and the count of their set bits (`func_80075A84` / `func_80075B00`), **each plus the slot's device offset**. The game's copy-to-pak path uses the *un-seeded* twins (`func_80075AC4` / `func_80075B60`), so every note slot in a pak validates with **seed 0** and is rejected in every battery slot until those two halfwords are rewritten (a blank battery slot reads `(0x4036+offset, 0x11FE+offset)`; the reseeded prologue slot reads `0x9549/0x1D19`). `assets/saves/*.n64` are **DexDrive Controller Pak dumps, not battery images**: 36928 bytes = a 0x1040-byte DexDrive header (`123-456-STD`) + a 32 KiB pak, and a scan of every offset finds no device magic, so no battery image is embedded. Each **live** 25-page note (`OgreBATTLE64 <n>`, game code `NOBE`, publisher `EB`) carries a verbatim copy of a battery slot at `note+0x20`; the pak's own FAT says which notes are live (deleting a note leaves its pages readable). `tools/sramsave.py` now extracts a pak's live notes into the battery's **two** save slots (0 and 1 — slot index 2's offset `0x30B0` is where the game's 19176-byte map record begins, so it covers the rest of the image) with the checksums reseeded (`--all` also takes the stale records, capped at two; `pak`/`check` report it), and `tools/run-save.sh <name>` imports a save into its own gitignored `.ogre-prefs-save-<name>/` and boots with it as the battery, while **`OGRE_SAVE=<name|path>`** (`app/src/save_import.cpp`, no runtime patch) does the same conversion in-process into the active config dir — it keeps a battery newer than the source so progress survives, and `OGRE_SAVE_RESET=1` re-imports. Verified: `prologue.n64` converted + `OGRE_TAP_SCENE_BUTTON="title:start:1,0x12:a:3,0x05:a:1"` reaches **title → `0x12` (the Load Game book) → `0x05` (the map)** with slot 0 byte-identical afterwards, and the game's **own data screen reads the battery back**: GAME DATA 1 is `Magnus / Prologue / Alba / 0:20:42` for `prologue.n64` versus `Magnus / Prologue / Alba / 0:07:02` for the older `save-mission-1.srm` import, in otherwise identical config dirs. **The scene route is not the evidence** — a blank battery also reaches `0x12`/`0x05` (A on the data screen starts a new game), so the discriminator is the displayed save data; the earlier "it reached the map" check was not discriminating and is corrected here. The same file imported without reseeding makes the game repair the whole image to its blank format (sha256 `ed38cfd7…`). Proofs `docs/proofs/native-load-game-prologue.png`, `native-load-game-battery-ab.png`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `tools/sramsave.py`, `tools/run-save.sh`, `app/src/save_import.cpp`, `docs/symbols.md` ("Save (battery SRAM) — the whole access path"); `docs/HANDOFF-2026-09-18-session78.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 2026-09-18 (77)     | **A per-frame wait for a condition that cannot become true is not "a slow frame", it is a whole slow scene: the RSP worker's 500 ms njpeg-framebuffer poll made the boot's publisher stills run at 2 display lists/s instead of 30.** Developer report: the boot's QUEST logo screen (the Nintendo/ATLUS/QUEST publisher stills, scene `0x0A`) "lags badly". One line of `OGRE_DL_TRACE=1` shows it — during scene `0x0A` display lists arrive every **516 ms** (2/s) while every other scene runs at 30/s — and one line of `OGRE_SYNC_TRACE=1` says why: `[njwait] spins=1941 found=0 ms=500` on *every* submitted list. `Application::waitForGameFramebuffers` (session 50) polls the RT64 framebuffer manager for three **fixed** addresses (`0x400`/`0x25C00`/`0x4B400`) with a 500 ms timeout; the publisher stills draw their 640x480 images elsewhere, so the condition can never be satisfied and the poll spends the whole timeout per frame (500 ms + ~16 ms of work = the observed 516 ms). **Every scene that does not render into those three addresses paid the same per-list stall**, which is why deleting it also removed slowdowns well beyond the publisher stills (developer-confirmed). It is also unnecessary: session 57 measured it as a no-op in the njpeg path (`spins=1 found=1 ms=0`) and established that the stage-3 CPU copy is ordered by the game's own **DP-completion** wait plus `ogre_sync_framebuffers()` — retail has no such wait. The call was deleted from `send_dl`; the RT64 helper is left in place (unused) so the submodule patch needs no regeneration. Verified: `OGRE_NJ_WAIT_MS=0` and the deletion both give 30 lists/s with the scene's 16.4 s duration unchanged (it is the *frame rate* that was 16× low, not the timing), and the njpeg regression still reads the four documented correct frames (`573FF47B8A5A3279`, `48892A76C362A4BA`, `3F79B6732153B2FD`, `38BCBEBE5B555C3C`, `alt=0`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `app/src/renderer.cpp`; `docs/HANDOFF-2026-09-18-session77.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| 2026-09-18 (76)     | **The audio latency was the AI busy bit: `osAiGetStatus` returned 0, so the game's audio thread never waited for the DAC and produced 3.5 % more audio than was played.** OB64's audio thread (`func_800859xx`, the caller of `osAiSetNextBuffer` at `0x800859BC`) is `while (osAiGetStatus() & 0x80000000) { update; }` → generate → queue, i.e. it is **paced by `AI_STATUS_BUSY`**. The runtime's `osAiGetStatus_recomp` was `ctx->r2 = 0; // Pretend the audio DMAs finish instantly`, so the loop ran at the *video* frame rate: **552 stereo frames × 60 = 33 120 frames/s** against a 32 000 Hz DAC (`osAiSetFrequency`), and the buffer size confirms the intent — 32 000 / 552 = 58.0 buffers/s, the audio period, not 60. The surplus accumulated in SDL's queue: measured with a temporary probe, the depth grew **linearly from 22 ms to 2 070 ms over 70 s** (~30 ms/s, reset only when the music stream restarted) and `osAiGetLength` was polled exactly 60×/s. Fix: `ultramodern::audio_dma_busy()` (true while more than a **52 ms cushion** of audio is queued) and `osAiGetStatus_recomp` returns `0x80000000` while busy. **The cushion is load-bearing, and the obvious fix is a trap:** `busy while queued != 0` pins the queue at 17.2 ms but makes the game generate only **34 buffers/s** with a push onto an empty queue every time — a 40 % underrun, and the "music drags and tears" the developer heard next, because the music engine advances per generated buffer. The port's audio loop only iterates ~120×/s, coarser than one 17 ms buffer, so the bit must clear *before* the queue empties. A measured sweep (0/36/52/69 ms → 34.0/58.5/58.0/58.0 pushes/s, empty pushes 68/15/0/0) chose 52 ms. Result: **58.0 pushes/s = the DAC rate, 0 underruns, queue 2–57 ms**, and `OGRE_NO_AUDIO=1` is unchanged (no device → never busy → the old path; `runlog --check` PASS). Change lives in the submodule (`librecomp/src/ai.cpp`, `ultramodern/src/audio.cpp`, `ultramodern/include/ultramodern/ultramodern.hpp`) and in `n64modernruntime-ob64.patch`, which must be regenerated with the nested `N64Recomp` submodule excluded or it picks up a bogus `Subproject commit` hunk: `git -C tools/N64ModernRuntime diff HEAD -- . ':(exclude)N64Recomp'`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `n64modernruntime-ob64.patch` (27 file diffs = previous 26 + `librecomp/src/ai.cpp`); `probe76`/`probe77` (SDL queue depth, poll rate, push rate and empty-push count, `app/src/sdl_platform.cpp`) fully reverted; runs `/tmp/s77-fin{1,2,3}.log` (58.0 pushes/s, 0 empty, 2–57 ms), `/tmp/s76-live.bin` (AI buffer 1100/1104 non-zero with the device open), headless `runlog --check` PASS; `docs/HANDOFF-2026-09-18-session76.md`                                                                                                                                                                                                                                                                                                                                                                                                                    |
| 2026-09-18 (75)     | **Native audio works, and session 74's wall was one wrong constant: `text_address` must be `0x1080`, because `0x8009E050` is the audio *text*, loaded by the standard libultra RSP boot loader — not a second boot block.** `task->t.ucode_boot = 0x8009ECB0` (ROM `0x2F0B0`, `0xD0` bytes) is the stock loader: disassembled at IMEM `0x1000` it does `addi at,zero,0xFC0` / `lw v0,0x10(at)` (`task->ucode`) / `addi v1,zero,0xF7F` / `mtc0 a3,SP_MEM_ADDR` (`a3 = 0x1080`) / `mtc0 v0,SP_DRAM_ADDR` / `mtc0 v1,SP_RD_LEN` / `jr a3`; before that it DMAs `ucode_data` (`0x800ABDA0`, its true `0x800` size) to **DMEM 0**. Session 74 compiled the same bytes at `text_address = 0x1000`, so every absolute `j`/`beq` target (which comes from the instruction encoding, not the label base) resolved 0x80 bytes early: the command-list DMA helper `L_1120` was entered mid-instruction, `$29` (`sp`) stayed 0, the dispatch read the table for the wrong opcode, and the output buffers stayed zero. **With `0x1080` the driver runs its real ABI and the AI buffer fills.** `rsp-audio.toml` is now `text_offset 0x2E450`, `text_size 0xC60`, `text_address 0x1080`: the loader's fixed `0xF80`-byte text DMA also copies the boot loader itself and the njpeg text into IMEM `0x1CE0`+, whose `j`s point below the text, so compiling the full window only emits `goto L_1064`-style undeclared labels (same rule as `rsp-njpeg.toml`'s `0x7B8`). The command loop dispatches through a **halfword table held as data in `ucode_data` at DMEM 0** (`srl $at,$k0,0x17` / `andi $at,$at,0xfe` / `lh $at,0($at)` / `jr $at`), so `extra_indirect_branch_targets` lists every 4-byte-aligned target the 16-entry aspMain ABI table can produce — `(entry OR 0x1000) & 0x1FFF`, which also handles the one low entry (`0x02B0` → `0x12B0`) — plus `0x10B4` for the `jr $5` return; opcodes 7/8 hold `0x0000` (this driver has no SEGMENT/SETBUFF) and the game does not emit them. Audio is now **on by default** (`OGRE_AUDIO_UCODE=0` stubs it for A/B). Evidence: a live console `dump` at t=5 s (scene `0x09`, intro) shows **1104/1104 non-zero stereo samples** at `*(0x800A9B90)`+0 (buf `0x8013EE70`, len `0x8A0`), smooth and spanning ~−9600..+5800; a stock 15 s run is `runlog --check` PASS (809 type-2 tasks, 0 stubbed non-gfx). `tools/runlog.py` was corrected — it classified **type 2 (`M_AUDTASK`) as gfx** (only type 1 goes to RT64) — and now fails `--check` on any non-gfx task served by the stub. Open follow-up: the runtime still wakes the game's audio thread with the session-16 dummy response on queue `0x800C49E8`; the real `OS_EVENT_AI` completion is registered but never fired (audio is correct and paced with the dummy). **One rough edge:** the game's `SETLOOP` (op `0x0F`) stores its loop address as a word at DMEM `0x0E`, i.e. exactly dispatch-table entries 7/8 (both `0x0000` in `ucode_data` — this driver has no SEGMENT/SETBUFF), so a rare op7/op8 dispatch `jr`s to half an audio-buffer address (`Unhandled jump target 0x1226`, 1 in ~25 runs). The store is faithful — aligning it down to `0x0C` would clobber entry 6 (SAVEBUFF), used constantly — and a recompiler cannot jump to a non-instruction target, so `app/src/rsp.cpp` wraps the ucode in `audio_ucode_guard`: log and report the task completed (one silent buffer) instead of the runtime exiting the process; audio-only, njpeg keeps the loud failure.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `rsp-audio.toml`, `app/src/rsp.cpp`, `tools/runlog.py`, `docs/guides/rsp-microcode.md`; probes `probe75`–`probe75e` in `app/src/{rsp,sdl_platform}.cpp` + generated `RspFuncs/audio_ucode.cpp`, all reverted (`grep -rl probe75 app/ RspFuncs/` empty, `make rsp-recomp`); runs `/tmp/s75-stock.log` (PASS), `/tmp/s75-live.bin` (AI buffer dump); `docs/HANDOFF-2026-09-18-session75.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
mission field, per the GameFAQs guide the developer pasted) showed its message,
entered the battle, and **ended in an instant victory with no enemy**. It is rare,
so a lucky test run was not an option.

**Reproduction without luck.** The trigger decodes from the ROM, so it can be
forced. `func_ovlN_801E7940` (unit N, record 7) is called every frame from mission
**state 0** (handler `0x801af34c`; the state table is `0x801EDC60`, which is how
state 0 = "field, check for encounters" was established). It needs a field unit
with `(unit[0] & 0x60011) == 0x40011`, then rolls `rand() % 72000 <= 50`
(`<= 10` when `func_80186230(17)` is false — the "greater when revisiting" case in
the guide), reads the **terrain byte under that unit** and indexes two tables in
record 7's data:

* `0x801ED780` — terrain → encounter group (`1` highway, `2` Plains, `3` Barrens,
  `4` Forest, `6` Highlands, `7` Marsh, `8/9/10` the snow types);
* `0x801ED79E` — `group*2 + rand()%2` beside the per-mission row at
  `0x801E7E38 + *(0x8019F4A1)*12` (byte − 3), stride `20`: the **class index**;
* the class is stored as **`class + 0x100`** at `0x801F0E24` and the unit index at
  `0x801F0E20`; `func_ovlN_801B8D64` sets state `46` and the camera globals, and
  the state-46 handler in `func_ovlN_801B9694` (`0x801BAB90`) posts the message
  using the class-name table at `0x80190000` (streamedB, stride `72`, name at
  `+4` of `0x80187A30 + class*72`).

Decoded this way, the two tables reproduce the guide's **entire** table set
(Tenne Plains → Young Dragon/Wyrm/Golem, Mylesia → Faerie/Gremlin/Wyrm/Golem,
…), which is the confidence check. Patching the two probability branches (and the
unit-flag test, so a stationary unit qualifies) makes the encounter fire on
demand; the message then rendered correctly *through* the failure, which is what
localised it downstream.

**Root cause.** Scene `0x0E`'s enter (`func_80177754`) DMAs a **setup fragment**
before the battle banks — icache `0x801D0860..0x801D16D0`, dcache to
`0x801D16E0`, `func_8009DA50(0x23A370, 0x801D0860, 0xE80)`, no BSS — then calls
**`0x801D0AAC`** (or `0x801D1508` on the other flag branch). The same loader arm is
in scene `0x0D`'s enter (`func_80178568`); scene `0x14`'s enter (`func_80178130`)
DMAs unit J into that RAM instead and calls `0x801D0860` (J's body), which is why
the Witch's Den rendered before this fix. The
port had **no record** for ROM `0x23A370`, so the main ELF's
`LOOKUP_FUNC(0x801D0AAC/0x801D1508)` resolved to the runtime's streamed stub.
`func_801D1508` is the battle participant setup (scans the 30 unit slots at
`0x801F0CD0`, `memset`s a 25-byte record, tags it) and `func_801D0AAC` reads the
16-byte table at `0x801D16D0`. **Normal battles still worked** (their units already
exist on the field); a neutral encounter's wild unit is created here, so the
battle began with an empty enemy side.

The run log said it in two lines — `[bank] UNKNOWN module rom=0x23A370
ram=0x801D0860` and `streamed function stub called @ 0x801D1508` — immediately
before the battle banks J (`0x213AE0`) and X (`0x22A250`) loaded. This is session
72's class exactly.

**Fix.** **Bank unit AH** (`bankRec10s`): one more bank of RAM `0x801D0860`, so it
must be its own unit (J's `bankRec10a` and I's `bankRec16` are the other banks of
that base; session 45's rule). `config-bankAH.yaml`/`.toml` split code `0xE70`
(`asm`) from data `0x10` (`data`, 16 zero bytes), the gap
`0x213AE0..0x23A370` opaque; `symbol_addrs-bankAH.txt` forces the three real
entries `0x801D0860`, `0x801D0AAC`, `0x801D1508`. `bank-recomp` is now **34 units /
44 records / 3512 functions**, `elfcheck` reports bankAH **0 differing bytes of
2339312**, `check-banks` OK. Fixed build: **0 `UNKNOWN module`, 0 stubs**, the log
shows `loading overlay record rom=0x23A370 … (3 functions)`, the Young Dragon
spawns and fights (`docs/proofs/native-neutral-encounter-battle.png`).
**Developer confirmed: "it worked".**

**Probe.** Tag `probe82`, three sites in generated `BankNFuncs/funcs_4.c`
(`0x801E7B08`, `0x801E7C70`, `0x801E7BBC`), reverted by `make bank-recomp` and
proven (`grep -rl probe82` empty). They are recorded in the handoff as the
shortest way to force a neutral encounter in a future session.

**Lesson.** `tools/arenamap.py` had printed this fragment since session 73 and
marked it *"1 uncompiled … no observed run streams"*. The tool was right; the
route coverage was not. A scene's setup module streams only on the path that
reaches that scene, so "no observed run streams it" is a statement about the
routes tried, not about the module.
