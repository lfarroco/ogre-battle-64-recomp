...
|---------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2026-09-20 (94c)    | **The Windows package must carry its own runtime DLLs, a failed boot must leave a file or a dialog, and the release workflow must smoke-test each package on the runner image that built it.** The developer: *"nothing happens in the windows version. nothing opens, no logs, nothing"*, then *"can we have a small smoke test in the os image that builds it?"*. The v0.2.0 `.exe` was sound (GUI subsystem, `WinMainCRTStartup` → `WinMain` → `main`, confirmed from its imported CRT entry markers), so the defect was elsewhere: `ogrebattle64.exe` statically imports `dxcompiler.dll`/`dxil.dll`, and **both of those Microsoft binaries import `MSVCP140.dll`, `VCRUNTIME140.dll` and `VCRUNTIME140_1.dll`**, which the package did not ship — a machine without the Visual C++ 2015-2022 redistributable cannot start the process, and a console-less image can report that as nothing at all. Landed: `CMAKE_MSVC_RUNTIME_LIBRARY=MultiThreaded` for every Windows target (app, N64ModernRuntime, RT64), SDL2 built with the same setting plus a stamp guard so a cached `-MD` SDL2 is rebuilt, a POST_BUILD copy of the four runtime DLLs from `VCToolsRedistDir` beside the `.exe`, and a `dist` recipe that copies them and fails when one is missing. Separately, four early-exit paths (SDL init, game window, start-screen window and renderer) ended the process with no file and no dialog; they now call `report_boot_failure()`, which writes `error.log` and shows the reason, and `init_sdl` requires only video and events (audio and controllers are optional: `SDL_Init` fails the whole call when any requested subsystem fails, and audio can fail on a host with no output device). The missing smoke test: `OGRE_SMOKE=1` exits 0 as soon as `main` is reached; `tools/pe_imports.py` requires every import of every shipped Windows binary to be shipped beside it or a system DLL; `tools/smoke-dist.sh` (`make smoke`) checks the companion files, runs the platform's import check and launches with `OGRE_SMOKE=1` under a deadline; the release workflow runs it on each matrix runner between packaging and collecting the archive. Verified: the macOS package passes `make smoke`; the shipped v0.2.0 Windows zip fails the PE check naming exactly the four missing DLLs and passes when they are added; `SDL_AUDIODRIVER=doesnotexist` still boots; a forced video failure writes `error.log`; the 45 s route run is `runlog.py --check` PASS. Windows itself is validated by the RC | `app/CMakeLists.txt`, `Makefile`, `.github/workflows/release.yml`, `app/src/{main,sdl_platform,launcher}.{cpp,hpp}`, `tools/smoke-dist.sh`, `tools/pe_imports.py`, `packaging/README-dist.txt`, `docs/guides/app-build.md`; `make smoke`, the v0.2.0 release zip, `SDL_AUDIODRIVER`/`SDL_VIDEODRIVER` forced failures; `docs/HANDOFF-2026-09-20-session94.md` part 3 |
