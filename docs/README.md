...
| [HANDOFF-2026-09-15-session43.md](HANDOFF-2026-09-15-session43.md) | Session 43 handoff (latest): bank unit B compiles records 17/18 and scene `0x17` renders as the **Tutorial** (the title menu is captured: New Game / Tutorial / Stereo); the movie-path word is `0x80197794`, not `0x8019F794`; and a probe shows the script VM's opcode `0x10` never asks for the `F1C0 == 0` movie step. |
