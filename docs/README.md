...
| [HANDOFF-2026-09-14-session35.md](HANDOFF-2026-09-14-session35.md) | Session 35 handoff (latest): the title screen's white band — six `G_TEXRECT`s drawn with a zero-texel tile, and the guard that skips them; the `OGRE_NOP_RECT` bisect tool; the RT64 patch regenerated. |
