...
| [HANDOFF-2026-09-12-session25.md](HANDOFF-2026-09-12-session25.md) | Session 25 handoff (latest): native runs drive themselves (`OGRE_TAP_MS`/`OGRE_EXIT_AFTER_MS`); the idle trajectory reproduced on native and localised to the RSP/frame worker queues. Sessions 12–24 are in `docs/` (session 24: the "green smudges" fixed, native RT64/Metal brought up). |
